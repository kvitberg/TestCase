...
extern "C"
{
    ...
    {
        uAutoReleasePool pool;
        ::g::Uno::Platform::EventSources::HardwareKeys::OnKeyUp(key, 0);
    }
}
...
extern "C"
{
    ...
    {
        uAutoReleasePool pool;
        ::g::Uno::Platform::EventSources::HardwareKeys::OnKeyDown(key, 0);
    }
}
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/testcase/TestCase");
    ...
    Xli::PlatformSpecific::Android::SetLogTag("TestCase");
