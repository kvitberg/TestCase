...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.5/$.uno
// -----------------------------------------------------------------------------------------
...
{
    ::TYPES[4] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(0/*Invoke1<Uno.Action>*/, ::g::Uno::Action_typeof(), NULL);
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    type->SetFields(0,
...
{
    ::g::Uno::Threading::IDispatcherExtensions__Invoke1_fn(::TYPES[4/*Uno.Threading.IDispatcherExtensions.Invoke1<Uno.Action>*/], uPtr(_context)->Dispatcher(), uDelegate::New(::TYPES[5/*Uno.Action<Uno.Action>*/], (void*)AppInitialized__Closure__RunJS_fn), _action);
}
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("(function(x) { return x; })");
    ::STRINGS[4] = uString::Const("(function(count) { return new Array(count); })");
    ::STRINGS[5] = uString::Const("(function() { return new Object; })");
    ::STRINGS[6] = uString::Const("(function(obj, name, getCallback, setCallback, e, c) { Object.defineProperty(obj, name, { get: getCallback, ");
    ::STRINGS[7] = uString::Const(" set: setCallback,");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[9] = uString::Const(" enumerable: e, configurable: c }); })");
    ...
    ::STRINGS[11] = uString::Const("JSON.parse");
    ::TYPES[6] = ::g::Uno::Threading::ConcurrentDictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Fuse::Scripting::ModuleResult_typeof(), NULL);
    ...
    type->SetFields(0,
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _identity), 0,
        ::TYPES[6/*Uno.Threading.ConcurrentDictionary<string, Fuse.Scripting.ModuleResult>*/], offsetof(::g::Fuse::Scripting::Context, _moduleResults), 0,
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _newArray), 0,
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _newObject), 0,
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _parseJson), 0,
        ::TYPES[9/*Fuse.Scripting.IThreadWorker*/], offsetof(::g::Fuse::Scripting::Context, _worker), 0);
}
...
{
    if (_identity == NULL)
        _identity = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[2/*"(Context)"*/], ::STRINGS[3/*"(function(x...*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    return uCast< ::g::Fuse::Scripting::Function*>(uPtr(_identity)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, c)), ::TYPES[7/*Fuse.Scripting.Function*/]);
}
...
{
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(::g::Fuse::Scripting::IThreadWorker::Dispatcher(uInterface(uPtr(_worker), ::TYPES[9/*Fuse.Scripting.IThreadWorker*/]))), ::TYPES[2/*Uno.Threading.IDispatcher*/]), action);
}
...
{
    if (_newArray == NULL)
        _newArray = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[2/*"(Context)"*/], ::STRINGS[4/*"(function(c...*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, uBox<int>(::TYPES[44/*int*/], uPtr(values)->Length()))), ::TYPES[10/*Fuse.Scripting.Array*/]);
...
{
    if (_newObject == NULL)
        _newObject = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[2/*"(Context)"*/], ::STRINGS[5/*"(function()...*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    return uCast< ::g::Fuse::Scripting::Object*>(uPtr(_newObject)->Call(uArray::New(::TYPES[8/*object[]*/], 0)), ::TYPES[11/*Fuse.Scripting.Object*/]);
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[6/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[7/*" set: setCa...*/] : ::STRINGS[8/*""*/]), ::STRINGS[9/*" enumerable...*/])), ::TYPES[7/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::g::Uno::Bool_typeof(), enumerable), uBox(::g::Uno::Bool_typeof(), configurable)));
}
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::STRINGS[10/*"(function(o...*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 5, obj, name, value, uBox(::g::Uno::Bool_typeof(), enumerable), uBox(::g::Uno::Bool_typeof(), configurable)));
}
...
{
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[2/*"(Context)"*/], ::STRINGS[11/*"JSON.parse"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);

    return uPtr(_parseJson)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, json));
}
...
{
    ::STRINGS[12] = uString::Const("Promise");
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[8] = uObject_typeof()->Array();
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[12/*"Promise"*/]), ::TYPES[7/*Fuse.Scripting.Function*/]);
    ::g::Uno::Threading::Future1* future = (::g::Uno::Threading::Future1*)uPtr(_factory)->Invoke(1, args);
    return uPtr(promise)->Construct(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, uDelegate::New(::TYPES[12/*Fuse.Scripting.Callback*/], (void*)::g::Fuse::Scripting::NativePromise__PromiseClosure__Run_fn, ::g::Fuse::Scripting::NativePromise__PromiseClosure::New1(__types[0], _c, future, _converter))));
}
...
{
    uPtr(o)->CallMethod(::STRINGS[13/*"emit"*/], _args);
}
...
{
    ::STRINGS[14] = uString::Const("Fuse.Reactive.JavaScript");
    ::STRINGS[15] = uString::Const("FuseJS/EventEmitter.js");
    ::STRINGS[16] = uString::Const("FuseJS/EventEmitter");
    ::STRINGS[17] = uString::Const("Unable to get a FuseJS/EventEmitter instance");
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    type->SetFields(0,
        ::TYPES[7/*Fuse.Scripting.Function*/], (uintptr_t)&::g::Fuse::Scripting::EventEmitterModule::_instance_, uFieldFlagsStatic);
}
...
::g::Fuse::Scripting::Function* EventEmitterModule::GetConstructor(::g::Fuse::Scripting::Context* c)
{
    ...
    {
        ::g::Uno::IO::BundleFile* fileSource = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[14/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[15/*"FuseJS/Even...*/]);
        uObject* exports = ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(fileSource))->EvaluateExports(c, ::STRINGS[16/*"FuseJS/Even...*/]);
        EventEmitterModule::_instance_ = uAs< ::g::Fuse::Scripting::Function*>(exports, ::TYPES[7/*Fuse.Scripting.Function*/]);

        if (EventEmitterModule::_instance_ == NULL)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[17/*"Unable to g...*/]));
    }
...
uObject* JSCallback__FuncClosure1::Run(uArray* args)
{
    ...
    if (::g::Uno::Type::op_Equality(__types[1], ::TYPES[8/*object[]*/]))
...
{
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[15] = JSCallback__ActionClosure1_typeof();
    ::TYPES[16] = JSCallback__ActionClosure2_typeof();
    ::TYPES[17] = JSCallback__FuncClosure_typeof();
    ::TYPES[18] = JSCallback__FuncClosure1_typeof();
    ::TYPES[19] = JSCallback__NumberConverter_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[15/*Fuse.Scripting.JSCallback.ActionClosure`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[16/*Fuse.Scripting.JSCallback.ActionClosure`2*/]->MakeType(type->MethodTypes[1]->U(0), type->MethodTypes[1]->U(1), NULL));
    type->MethodTypes[2]->SetPrecalc(
        ::TYPES[17/*Fuse.Scripting.JSCallback.FuncClosure`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL));
    type->MethodTypes[3]->SetPrecalc(
        ::TYPES[18/*Fuse.Scripting.JSCallback.FuncClosure`2*/]->MakeType(type->MethodTypes[3]->U(0), type->MethodTypes[3]->U(1), NULL));
    type->MethodTypes[4]->SetPrecalc(
        ::TYPES[19/*Fuse.Scripting.JSCallback.NumberConverter*/]->MakeMethod(1/*TryConvert<T>*/, type->MethodTypes[4]->U(0), NULL));
}
...
{
    ::STRINGS[18] = uString::Const("exports");
    ::STRINGS[19] = uString::Const("disposed");
    ::STRINGS[20] = uString::Const("id");
    ::TYPES[8] = uObject_typeof()->Array();
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[18/*"exports"*/], CreateExportsObject(c));
    module->Item(::STRINGS[19/*"disposed"*/], c->NewArray(uArray::New(::TYPES[8/*object[]*/], 0)));
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[20/*"id"*/], id);
...
{
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[18/*"exports"*/]);
    return r;
}
...
{
    ::STRINGS[19] = uString::Const("disposed");
    ::STRINGS[21] = uString::Const("(unknown module)");
    ::TYPES[21] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[22] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[23] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[10] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[8] = uObject_typeof()->Array();
    type->SetFields(0,
        ...
        ::TYPES[21/*Uno.Collections.List<Uno.Action>*/], offsetof(::g::Fuse::Scripting::ModuleResult, _invalidateCallbacks), 0,
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[21/*"(unknown mo...*/], void();
}
...
{
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[21/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[22/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[23/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}
...
void ModuleResult::Dispose()
{
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[23/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[22/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
{
    if (uPtr(Object)->ContainsKey(::STRINGS[19/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[19/*"disposed"*/]), ::TYPES[10/*Fuse.Scripting.Array*/]);

        if (disposed != NULL)

            for (int i = 0; i < uPtr(disposed)->Length(); i++)
            {
                ::g::Fuse::Scripting::Function* func = uCast< ::g::Fuse::Scripting::Function*>(uPtr(disposed)->Item(i), ::TYPES[7/*Fuse.Scripting.Function*/]);

                if (func != NULL)
                    uPtr(func)->Call(uArray::New(::TYPES[8/*object[]*/], 0));
            }
    }
}
...
{
    ::STRINGS[22] = uString::Const("this.Context != null");
    ::STRINGS[23] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.5/$.uno");
    ::TYPES[24] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array(), NULL);
    ::TYPES[25] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(1/*Invoke1<object[], object>*/, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[8] = uObject_typeof()->Array();
    ...
    type->SetFields(8,
        ::TYPES[24/*Uno.Collections.Queue<object[]>*/], offsetof(::g::Fuse::Scripting::NativeEvent, _eventArgsQueue), 0,
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[24/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[25/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[26/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}

// internal object RaiseSync(object[] args) [instance] :897
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[22/*"this.Contex...*/], ::STRINGS[23/*"../../../Li...*/], 899, uArray::New(::TYPES[8/*object[]*/], 0));

    if (_jsFunction != NULL)
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[25/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[26/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), args);
...
{
    ::STRINGS[24] = uString::Const("removeAllListeners");
    ::TYPES[27] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL), NULL);
    ::TYPES[28] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL), NULL);
    ::TYPES[29] = ::g::Uno::EventHandler_typeof();
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[30] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2/*Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/, ::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[32] = ::g::Uno::Tuple_typeof()->MakeMethod(0/*Create<object, Fuse.Scripting.Callback>*/, uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[2] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[8] = uObject_typeof()->Array();
    ::TYPES[33] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[12/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(4,
        ...
        ::TYPES[8/*object[]*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _eventNames), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _initialized), 0,
        ::TYPES[27/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _listeningCallbacks), 0,
        uObject_typeof(), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _mutex), 0,
        ::TYPES[28/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _queuedEvents), 0,
...
{
    _listeningCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[27/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/]));
    _mutex = ::g::Uno::Object::New();
    _queuedEvents = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[28/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/]));
    ctor_1();
    _queueEventsBeforeInit = queueEventsBeforeInit;
    _eventNames = eventNames;
    add_Reset(uDelegate::New(::TYPES[29/*Uno.EventHandler*/], (void*)NativeEventEmitterModule__ResetListeners_fn, this));
}
...
void NativeEventEmitterModule::Dispatch(uDelegate* action, bool alwaysQueueEventBeforeInit)
{
    ...
    ::g::Uno::Threading::IDispatcherExtensions__Invoke2_fn(::TYPES[30/*Uno.Threading.IDispatcherExtensions.Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], uPtr(_context)->Dispatcher(), action, _context, _this);
}

// protected void Emit(object[] args) [instance] :991
void NativeEventEmitterModule::Emit(uArray* args)
{
    Dispatch(uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__EmitClosure__Emit_fn, NativeEventEmitterModule__EmitClosure::New1(args)), false);
}
...
void NativeEventEmitterModule::On(uObject* eventName, uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Add_fn(uPtr(_listeningCallbacks), (::g::Uno::Tuple__Create1_fn(::TYPES[32/*Uno.Tuple.Create<object, Fuse.Scripting.Callback>*/], eventName, listener, &ret4), ret4));
    }

    Dispatch(uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1(eventName, listener)), true);
}
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[24/*"removeAllLi...*/], uArray::New(::TYPES[8/*object[]*/], 0));
    ::g::Uno::Threading::Monitor::Enter(_mutex);

    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Tuple2*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_listeningCallbacks), &ret6), ret6); enum1.MoveNext(::TYPES[33/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]); )
        {
            ::g::Uno::Tuple2* l = enum1.Current(::TYPES[33/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]);
            Dispatch(uDelegate::New(::TYPES[31/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1((::g::Uno::Tuple2__get_Item1_fn(uPtr(l), &ret7), ret7), (::g::Uno::Tuple2__get_Item2_fn(uPtr(l), &ret8), ret8))), true);
        }
    }
...
static void NativeModule_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("exports");
    ::TYPES[34] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[11] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[35] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[29] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ::TYPES[34/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/], offsetof(::g::Fuse::Scripting::NativeModule, _members), 0,
        ::TYPES[29/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::NativeModule, Reset1), 0);
}
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[18/*"exports"*/]), ::TYPES[11/*Fuse.Scripting.Object*/]);

        if (obj != NULL)

            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[35/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
            {
                ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[35/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
                uPtr(m)->Create(obj, c);
            }
    }
}
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[34/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
{
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Reset1, value), ::TYPES[29/*Uno.EventHandler*/]);
}

// public generated void remove_Reset(Uno.EventHandler value) [instance] :1232
void NativeModule::remove_Reset(uDelegate* value)
{
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Reset1, value), ::TYPES[29/*Uno.EventHandler*/]);
}
// }
...
{
    ::TYPES[36] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[37] = NativePromise__ContextClosure_typeof();
    ::TYPES[38] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[39] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[40] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(3,
        ...
        ::TYPES[36/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativePromise, _futureFactory), 0,
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[39/*Uno.Threading.ThreadStart*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future)))->Start();
    return future;
}
...
{
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[41] = ::g::Uno::Func_typeof();
    ::TYPES[42] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        type->T(1),
        type->T(0),
    ...
    type->SetFields(3,
        ::TYPES[41/*Uno.Func`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _getHandler), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeProperty, _isReadonly), 0,
        type->T(1), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[42/*Uno.Action`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _setHandler), 0,
...
static void JSCallback__NumberConverter_build(uType* type)
{
    ...
    ::TYPES[45] = ::g::Uno::Long_typeof();
    ::TYPES[46] = ::g::Uno::Float_typeof();
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[43/*short*/]))
        return uBox<int16_t>(::TYPES[43/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[44/*int*/]))
        return uBox<int>(::TYPES[44/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[45/*long*/]))
        return uBox<int64_t>(::TYPES[45/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[46/*float*/]))
        return uBox(::TYPES[46/*float*/], (float)value);

    return uBox(::TYPES[47/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[47/*double*/]))
        return uBox(::TYPES[47/*double*/], (double)value);

    return uBox(::TYPES[46/*float*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[44/*int*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[45/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[43/*short*/], value);
}
...
{
    if (uIs(value, ::TYPES[43/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[43/*short*/], value), targetType);

    if (uIs(value, ::TYPES[44/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[44/*int*/], value), targetType);

    if (uIs(value, ::TYPES[45/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[45/*long*/], value), targetType);

    if (uIs(value, ::TYPES[46/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[46/*float*/], value), targetType);

    if (uIs(value, ::TYPES[47/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[47/*double*/], value), targetType);
...
{
    uPtr(o)->CallMethod(::STRINGS[26/*"on"*/], uArray::Init<uObject*>(::TYPES[8/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[42] = ::g::Uno::Action1_typeof();
    ::TYPES[48] = ::TYPES[42/*Uno.Action`1*/]->MakeType(::g::Uno::Exception_typeof(), NULL);
    type->SetPrecalc(
        type->T(1),
    ...
    type->SetFields(0,
        ...
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::NativePromise__PromiseClosure, _reject), 0,
        ::TYPES[7/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::NativePromise__PromiseClosure, _resolve), 0,
...
{
    uPtr(_reject)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, (uString*)uPtr(_reason)->Message()));
}
...
void NativePromise__PromiseClosure::InternalResolve()
{
    ...
    if (::g::Uno::Delegate::op_Inequality(_converter, NULL))
        uPtr(_resolve)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, uBoxPtr(__types[0], (uPtr(_converter)->Invoke(&ret2, 2, (::g::Fuse::Scripting::Context*)_c, (void*)_result()), ret2))));
    else
        uPtr(_resolve)->Call(uArray::Init<uObject*>(::TYPES[8/*object[]*/], 1, uBoxPtr(__type->T(0), _result())));
}
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    if (uPtr(args)->Length() > 1)
        _reject = uAs< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(1), ::TYPES[7/*Fuse.Scripting.Function*/]);

    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[48/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("require(): module not found: ");
    ::STRINGS[31] = uString::Const("JavaScript error in ");
    ::STRINGS[32] = uString::Const(" was fixed!");
    ::STRINGS[33] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.5/$.uno");
    ::STRINGS[34] = uString::Const("Require");
    ::STRINGS[35] = uString::Const(" line ");
    ::STRINGS[36] = uString::Const(". ");
    ::STRINGS[18] = uString::Const("exports");
    ::TYPES[49] = ::g::Uno::String_typeof();
    ::TYPES[3] = ::g::Uno::Action_typeof();
    type->SetFields(0,
        ...
        ::TYPES[49/*string*/], (uintptr_t)&::g::Fuse::Scripting::ScriptModule__RequireContext::_lastErrorPath_, uFieldFlagsStatic);
}
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[27/*"require(): ...*/], uBox<int>(::TYPES[44/*int*/], uPtr(args)->Length())), ::STRINGS[28/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[49/*string*/]);
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[30/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[32/*" was fixed!"*/]), this, ::STRINGS[33/*"/Users/kits...*/], 1879, ::STRINGS[34/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[35/*" line "*/]), uBox<int>(::TYPES[44/*int*/], uPtr(e)->LineNumber())), ::STRINGS[36/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[33/*"/Users/kits...*/], 1889, ::STRINGS[34/*"Require"*/], NULL);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[18/*"exports"*/]);
}
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[50/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[50] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), type, NULL);
    type->SetFields(0,
        ...
        ::TYPES[50/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/], (uintptr_t)&::g::Fuse::Scripting::ScriptClass::_unoTypeToScriptClass_, uFieldFlagsStatic);
}
...
{
    ::STRINGS[37] = uString::Const("Name: ");
    ::STRINGS[38] = uString::Const("Error message: ");
    ::STRINGS[39] = uString::Const("File name: ");
    ::STRINGS[40] = uString::Const("Line number: ");
    ::STRINGS[41] = uString::Const("Source line: ");
    ::STRINGS[42] = uString::Const("JS stack trace: ");
    ::TYPES[44] = ::g::Uno::Int_typeof();
    type->SetFields(3,
        ...
        ::TYPES[44/*int*/], offsetof(::g::Fuse::Scripting::ScriptException, _LineNumber), 0,
...
{
    ::STRINGS[43] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[33] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.0.5/$.uno");
    ::STRINGS[44] = uString::Const("Call");
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[51] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Cannot call...*/], __this, ::STRINGS[33/*"/Users/kits...*/], 1582, ::STRINGS[44/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[45/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[45] = uString::Const("require(): module contains an error: ");
    ::STRINGS[46] = uString::Const(".js");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[47] = uString::Const(".");
    ::STRINGS[48] = uString::Const("/");
    ::STRINGS[49] = uString::Const("..");
    ::STRINGS[50] = uString::Const("(function(");
    ::STRINGS[51] = uString::Const(") { ");
    ::STRINGS[52] = uString::Const("\n"
        " })");
    ::STRINGS[53] = uString::Const("Could not evaluate module '");
    ::STRINGS[54] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[18] = uString::Const("exports");
    ::STRINGS[55] = uString::Const("module, exports, require");
    ::STRINGS[56] = uString::Const("/index.js");
    ::TYPES[52] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[53] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[54] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[7] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[55] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[56] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[57] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[58] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uArray* newlines = uArray::New(::TYPES[53/*char[]*/], offset);

    for (int i = 0; i < offset; ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<object>*/]);
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[50/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[51/*") { "*/]), uString::CharArray(newlines)), __this->GetEffectiveCode()), ::STRINGS[52/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[53/*"Could not e...*/], __this->FileName()), ::STRINGS[54/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[18/*"exports"*/]));
    ::g::Uno::Collections::List__Add_fn(args, uDelegate::New(::TYPES[12/*Fuse.Scripting.Callback*/], (void*)ScriptModule__RequireContext__Require_fn, ScriptModule__RequireContext::New1(c, __this, result)));
    return *__retval = ::STRINGS[55/*"module, exp...*/], void();
}
...
{
    return uIs(obj, ::TYPES[52/*Fuse.Scripting.IModuleProvider*/]);
}
...
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[46/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[46/*".js"*/], ::STRINGS[8/*""*/]);

    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[47/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[48/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::GetSourcePath()
{
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[53/*char[]*/], 1, '/'));
    else
        return ::STRINGS[8/*""*/];
}
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[55/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[56/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[57/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[55/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[56/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[57/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[58/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[52/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[53/*char[]*/], 1, '/'));

    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[8/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[47/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[49/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[48/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[46/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[56/*"/index.js"*/])))
        return true;
...
{
    ctor_(name);
    Modifier = ((modifier != NULL) ? modifier : ::STRINGS[8/*""*/]);
}
// }
...
{
    ::STRINGS[57] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetPrecalc(
        type->T(0));
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[57/*"ScriptPrope...*/]));
...
{
    if (uIs(obj, ::TYPES[47/*double*/]))
        return uUnbox<double>(::TYPES[47/*double*/], obj);

    if (uIs(obj, ::TYPES[46/*float*/]))
        return (double)uUnbox<float>(::TYPES[46/*float*/], obj);

    if (uIs(obj, ::TYPES[44/*int*/]))
        return (double)uUnbox<int>(::TYPES[44/*int*/], obj);

    if (uIs(obj, ::TYPES[60/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[60/*uint*/], obj);
