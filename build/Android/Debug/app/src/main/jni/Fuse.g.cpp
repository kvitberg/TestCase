...
// public static string get_ReleaseVersion() [static] :251
...
static void App_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::TimerEventArgs_typeof(), NULL);
...
void App::ctor_3()
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_renderPanel)->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), _graphicsView);
    ::g::Fuse::MobileBootstrapping::Init();
    RootViewport(::g::Fuse::Controls::Native::NativeRootViewport::New4(::g::Fuse::Controls::Native::ViewHandle::New1(::g::Fuse::Android::AppRoot::Handle())));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(RootViewport())->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), _renderPanel);
    uPtr(::g::Uno::Platform::Displays::MainDisplay())->add_Tick(uDelegate::New(::TYPES[2/*Uno.EventHandler<Uno.Platform.TimerEventArgs>*/], (void*)App__OnTick_fn, this));
}

// public Fuse.Visual get_ChildrenVisual() [instance] :196
::g::Fuse::Visual* App::ChildrenVisual()
{
    return _graphicsView;
}

// private void OnTick(object sender, Uno.Platform.TimerEventArgs args) [instance] :199
...
// private void PropagateBackground() [instance] :223
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.5/$.uno
// -------------------------------------------------------------------------------------
...
void AppBase::DrawSelection(::g::Fuse::DrawContext* dc)
{
    ...
    {
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_selection), &ret3), ret3); enum1.MoveNext(::TYPES[9/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
        {
...
// protected void OnUpdate() [instance] :432
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.5/$.uno");
...
{
    if (Parent() != NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[2/*"double Bind...*/], this, ::STRINGS[3/*"/Users/kits...*/], 477, ::STRINGS[4/*"Root"*/]);
...
{
    if (Parent() == NULL)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"double Bind...*/], this, ::STRINGS[3/*"/Users/kits...*/], 486, ::STRINGS[6/*"Unroot"*/]);
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.5/$.uno
// --------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.5/$.uno
// ---------------------------------------------------------------------------------------
...
static void Node__DataFinder_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    type->SetInterfaces(
...
bool Node__DataFinder::NextData(uObject* data)
{
    ...
    {
        uObject* obj = uAs<uObject*>(data, ::TYPES[13/*Fuse.IObject*/]);

        if (obj != NULL)
        {
            if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[13/*Fuse.IObject*/]), _key))
            {
                Resolve(::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[13/*Fuse.IObject*/]), _key));
                return false;
            }
        }
    }
...
{
    __this->_data = data;
    ::g::Uno::Threading::IDispatcher::Invoke(uInterface(uPtr(uPtr(__this->_context)->Dispatcher()), ::TYPES[14/*Uno.Threading.IDispatcher*/]), uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Node__DataWatcher__Update_fn, __this));
}
...
void Node__DataWatcher::ctor_1(::g::Fuse::Node* node, ::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Function* updateCallback, uString* key)
{
    ...
    ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Node__DataWatcher__Subscribe_fn, this));
}

// public void Dispose() [instance] :2924
void Node__DataWatcher::Dispose()
{
    ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)Node__DataWatcher__Unsubscribe_fn, this));
}
...
{
    uPtr(_updateCallback)->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, (uObject*)uPtr(_context)->Unwrap(_data)));
}
...
static void Diagnostics_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("");
    ::TYPES[16] = ::g::Fuse::DiagnosticHandler_typeof();
    type->SetFields(0,
        ::TYPES[16/*Fuse.DiagnosticHandler*/], (uintptr_t)&::g::Fuse::Diagnostics::DiagnosticDismissed1_, uFieldFlagsStatic,
        ::TYPES[16/*Fuse.DiagnosticHandler*/], (uintptr_t)&::g::Fuse::Diagnostics::DiagnosticReported1_, uFieldFlagsStatic);
}
...
{
    Diagnostics::DiagnosticDismissed1_ = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Diagnostics::DiagnosticDismissed1_, value), ::TYPES[16/*Fuse.DiagnosticHandler*/]);
}
...
{
    Diagnostics::DiagnosticDismissed1_ = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Diagnostics::DiagnosticDismissed1_, value), ::TYPES[16/*Fuse.DiagnosticHandler*/]);
}
...
{
    Diagnostics::DiagnosticReported1_ = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Diagnostics::DiagnosticReported1_, value), ::TYPES[16/*Fuse.DiagnosticHandler*/]);
}
...
{
    Diagnostics::DiagnosticReported1_ = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Diagnostics::DiagnosticReported1_, value), ::TYPES[16/*Fuse.DiagnosticHandler*/]);
}
// }
...
static void DrawContext_build(uType* type)
{
    ...
    ::TYPES[17] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::IRenderViewport_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::RenderTargetEntry_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Int4_typeof(), NULL);
    ::TYPES[20] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::PolygonFace_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[20/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/], offsetof(::g::Fuse::DrawContext, _cullFaces), 0,
        ...
        ::TYPES[19/*Uno.Collections.List<int4>*/], offsetof(::g::Fuse::DrawContext, _glScissors), 0,
        ...
        ::TYPES[18/*Uno.Collections.List<Fuse.RenderTargetEntry>*/], offsetof(::g::Fuse::DrawContext, _renderTargets), 0,
        ...
        ::TYPES[17/*Uno.Collections.List<Fuse.IRenderViewport>*/], offsetof(::g::Fuse::DrawContext, _viewports), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::DrawContext, _IsCaching), 0,
        ::TYPES[26/*Uno.EventHandler*/], offsetof(::g::Fuse::DrawContext, RenderTargetChange1), 0);
}
...
{
    _viewports = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[17/*Uno.Collections.List<Fuse.IRenderViewport>*/]));
    _renderTargets = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[18/*Uno.Collections.List<Fuse.RenderTargetEntry>*/]));
    _glScissors = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[19/*Uno.Collections.List<int4>*/]));
    _cullFaces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[20/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/]));
    _handle = (void*)NULL;
    _viewport = viewport;
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 581, ::STRINGS[22/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 735, ::STRINGS[23/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 647, ::STRINGS[31/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 776, ::STRINGS[32/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 820, ::STRINGS[33/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    ::g::Fuse::RenderTargetEntry* old = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[22/*Uno.Collections.IListExtensions.RemoveLast<Fuse.RenderTargetEntry>*/], (uObject*)_renderTargets, &ret4), ret4);
    _renderTarget = uPtr(old)->RenderTarget;
    GLFramebuffer(uPtr(old)->GLFramebuffer);
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 697, ::STRINGS[24/*"PopRenderTa...*/]);
...
{
    ::g::Uno::Int4 ret5;
    ::g::Uno::Int4 s = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[23/*Uno.Collections.IListExtensions.RemoveLast<int4>*/], (uObject*)_glScissors, &ret5), ret5);
    GLScissor(s);
}
...
void DrawContext::PopViewport()
{
    uObject* ret6;
    OnRenderTargetChange();
    _viewport = (::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[24/*Uno.Collections.IListExtensions.RemoveLast<Fuse.IRenderViewport>*/], (uObject*)_viewports, &ret6), ret6);
}
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[3/*"/Users/kits...*/], 676, ::STRINGS[25/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Unpopped Sc...*/], this, ::STRINGS[3/*"/Users/kits...*/], 607, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unpopped Cu...*/], this, ::STRINGS[3/*"/Users/kits...*/], 611, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Unpopped Vi...*/], this, ::STRINGS[3/*"/Users/kits...*/], 615, ::STRINGS[27/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[30/*"Unpopped Re...*/], this, ::STRINGS[3/*"/Users/kits...*/], 619, ::STRINGS[27/*"ReleaseRoot...*/]);
...
{
    RenderTargetChange1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RenderTargetChange1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
{
    RenderTargetChange1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RenderTargetChange1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
static void FileSourceConverter_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[32] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    type->SetInterfaces(
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[29/*string*/]))
    {
        uString* path = uCast<uString*>(obj, ::TYPES[29/*string*/]);
        ...
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[32/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret3), ret3);

            if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), path))
                return ::g::Uno::UX::BundleFileSource::New1(f);
        }

        return ::g::Fuse::JSFileSource::New1(uCast<uString*>(obj, ::TYPES[29/*string*/]));
    }
    else if (uIs(obj, ::TYPES[13/*Fuse.IObject*/]))
        return ::g::Fuse::JSFileSource::New1(uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[13/*Fuse.IObject*/]), ::STRINGS[34/*"path"*/]), ::TYPES[29/*string*/]));
...
{
    Font::Thin_ = ::g::Fuse::SystemFont::New3(::STRINGS[35/*"sans-serif-...*/], 0, 1);
    Font::Light_ = ::g::Fuse::SystemFont::New3(::STRINGS[36/*"sans-serif-...*/], 0, 2);
    Font::Regular_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 0, 3);
    Font::Medium_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 0, 4);
    Font::Bold_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 0, 6);
    Font::ThinItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[35/*"sans-serif-...*/], 1, 1);
    Font::LightItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[36/*"sans-serif-...*/], 1, 2);
    Font::Italic_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 1, 3);
    Font::MediumItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 1, 4);
    Font::BoldItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[37/*"sans-serif"*/], 1, 6);
}

static void Font_build(uType* type)
{
    ::STRINGS[35] = uString::Const("sans-serif-thin");
    ::STRINGS[36] = uString::Const("sans-serif-light");
    ::STRINGS[37] = uString::Const("sans-serif");
    type->SetFields(0,
...
static void FramebufferPoolImpl_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[36/*Uno.Collections.List<Fuse.CacheFramebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, cacheFramebuffers), 0,
        ::g::Uno::Int_typeof(), offsetof(::g::Fuse::FramebufferPoolImpl, frame), 0,
        ::TYPES[33/*Uno.Collections.List<framebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, framebufferPool), 0,
        ::g::Uno::Int_typeof(), offsetof(::g::Fuse::FramebufferPoolImpl, framebuffersProvidedSinceLastCollect), 0,
        ::TYPES[34/*Uno.Collections.Dictionary<framebuffer, int>*/], offsetof(::g::Fuse::FramebufferPoolImpl, lastFrameUsed), 0,
        ::TYPES[35/*Uno.Collections.HashSet<framebuffer>*/], offsetof(::g::Fuse::FramebufferPoolImpl, lockedFramebuffers), 0,
...
void FramebufferPoolImpl::CollectCacheFramebuffers()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::CacheFramebuffer*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(cacheFramebuffers), &ret3), ret3); enum1.MoveNext(::TYPES[37/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]); )
    {
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[38/*"Attempted t...*/], uBox<int>(::TYPES[45/*int*/], width)), ::STRINGS[39/*"x"*/]), uBox<int>(::TYPES[45/*int*/], height)), ::STRINGS[40/*" framebuffe...*/]), uBox<int>(::TYPES[45/*int*/], maxSize)), ::STRINGS[39/*"x"*/]), uBox<int>(::TYPES[45/*int*/], maxSize))));
...
{
    GraphicsWorker::_exceptionQueue_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[39/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
}

static void GraphicsWorker_build(uType* type)
{
    ::STRINGS[43] = uString::Const("_exceptionQueue mismatch");
    ::STRINGS[44] = uString::Const("GraphicsWorker failed");
    ::STRINGS[45] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.5/$.uno");
    ::STRINGS[46] = uString::Const("Run");
    ::TYPES[39] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Exception_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[40] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::TYPES[6/*Uno.Action*/], NULL);
    ::TYPES[41] = ::g::Uno::Threading::ThreadStart_typeof();
    type->SetFields(0,
        ::TYPES[39/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], (uintptr_t)&::g::Fuse::GraphicsWorker::_exceptionQueue_, uFieldFlagsStatic,
        ...
        ::TYPES[40/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], (uintptr_t)&::g::Fuse::GraphicsWorker::_work_, uFieldFlagsStatic);
}
...
void GraphicsWorker::DispatchException()
{
    ...
    if (!(::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_exceptionQueue()), (void**)(&e), &ret1), ret1))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[43/*"_exceptionQ...*/]));
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating())
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work()), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[44/*"GraphicsWor...*/], e, a, ::STRINGS[45/*"/Users/kits...*/], 2023, ::STRINGS[46/*"Run"*/]);
...
void GraphicsWorker::Start()
{
    ...
    ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[5/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)GraphicsWorker__OnTerminating_fn));
    GraphicsWorker::_work() = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[40/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    GraphicsWorker::_thread() = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[41/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Common/1.0.5/resources/$.uno
// ------------------------------------------------------------------------------------------------
...
{
    ILoadingStatic::IsLoadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[47/*"IsLoading"*/]);
}

static void ILoadingStatic_build(uType* type)
{
    ::STRINGS[47] = uString::Const("IsLoading");
    type->SetFields(0,
...
{
    ::STRINGS[48] = uString::Const("Json.Stringify(): object can not contain cycles");
    ...
    ::STRINGS[54] = uString::Const("null");
    ::STRINGS[55] = uString::Const("true");
    ::STRINGS[56] = uString::Const("false");
    ...
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    ::TYPES[47] = ::TYPES[29/*string*/]->Array();
    ::TYPES[48] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<string>*/, ::TYPES[29/*string*/], NULL);
    ::TYPES[49] = ::g::Uno::Array_typeof()->MakeMethod(3/*Sort<string>*/, ::TYPES[29/*string*/], NULL);
    ::TYPES[50] = ::g::Uno::Comparison_typeof()->MakeType(::TYPES[29/*string*/], NULL);
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    if (uIs(value, ::TYPES[29/*string*/]))
        Json::ToLiteral3(uCast<uString*>(value, ::TYPES[29/*string*/]), sb);
    ...
    else if (uIs(value, ::TYPES[13/*Fuse.IObject*/]))
    {
        if ((::g::Uno::Collections::HashSet__Contains_fn(uPtr(visitedSet), value, &ret1), ret1))
            U_THROW(::g::Uno::Exception::New2(::STRINGS[48/*"Json.String...*/]));

        ::g::Uno::Collections::HashSet__Add_fn(uPtr(visitedSet), value, &ret2);
        uObject* obj = uAs<uObject*>(value, ::TYPES[13/*Fuse.IObject*/]);
        uPtr(sb)->Append2(::STRINGS[49/*"{"*/]);
        uArray* keys = uArray::New(::TYPES[47/*string[]*/], uPtr(::g::Fuse::IObject::Keys(uInterface(uPtr(obj), ::TYPES[13/*Fuse.IObject*/])))->Length());
        ::g::Uno::Array::Copy1(::TYPES[48/*Uno.Array.Copy<string>*/], ::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[13/*Fuse.IObject*/])), keys, uPtr(::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[13/*Fuse.IObject*/])))->Length());
        ...
        for (int i = 0; i < keys->Length(); i++)
        {
            ...
            Json::Stringify1(::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[13/*Fuse.IObject*/]), keys->Strong<uString*>(i)), normalized, sb, visitedSet);
        }
    ...
    else if (uIs(value, ::TYPES[51/*Fuse.IArray*/]))
    {
        ...
        sb->Append2(::STRINGS[53/*"]"*/]);
    }
    else
        uPtr(sb)->Append2(::STRINGS[54/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[55/*"true"*/];
    else
        return ::STRINGS[56/*"false"*/];
}
...
{
    Marshal::_computers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[52/*Uno.Collections.Dictionary<Uno.Type, Fuse.Computer>*/]));
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[53/*Uno.Collections.List<Fuse.Marshal.IConverter>*/]));
    ...
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[62/*short*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[65/*sbyte*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[61/*uint*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[63/*ushort*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[64/*byte*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[59/*Uno.UX.Size*/], ::g::Fuse::SizeComputer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[60/*Uno.UX.Size2*/], ::g::Fuse::Size2Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[29/*string*/], ::g::Fuse::StringComputer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[56/*float2*/], ::g::Fuse::Float2Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[57/*float3*/], ::g::Fuse::Float3Computer::New1());
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[58/*float4*/], ::g::Fuse::Float4Computer::New1());
...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("px");
    ::STRINGS[50] = uString::Const(",");
    ::STRINGS[55] = uString::Const("true");
    ::STRINGS[60] = uString::Const("True");
    ::STRINGS[56] = uString::Const("false");
    ::STRINGS[61] = uString::Const("False");
    ::STRINGS[62] = uString::Const("#");
    ::STRINGS[63] = uString::Const("Cannot convert '");
    ::STRINGS[64] = uString::Const("' to target type '");
    ::STRINGS[65] = uString::Const("'");
    ::STRINGS[66] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Marshal/1.0.5/$.uno");
    ::STRINGS[67] = uString::Const("TryConvertTo");
    ::TYPES[52] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ::g::Fuse::Computer_typeof(), NULL);
    ::TYPES[53] = ::g::Uno::Collections::List_typeof()->MakeType(Marshal__IConverter_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Type_typeof();
    ::TYPES[54] = Marshal__IConverter_typeof();
    ::TYPES[55] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[46] = ::g::Uno::Bool_typeof();
    ::TYPES[29] = ::g::Uno::String_typeof();
    ::TYPES[43] = ::g::Uno::Double_typeof();
    ::TYPES[44] = ::g::Uno::Float_typeof();
    ::TYPES[45] = ::g::Uno::Int_typeof();
    ::TYPES[56] = ::g::Uno::Float2_typeof();
    ::TYPES[57] = ::g::Uno::Float3_typeof();
    ::TYPES[58] = ::g::Uno::Float4_typeof();
    ::TYPES[59] = ::g::Uno::UX::Size_typeof();
    ::TYPES[60] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[61] = ::g::Uno::UInt_typeof();
    ::TYPES[62] = ::g::Uno::Short_typeof();
    ::TYPES[63] = ::g::Uno::UShort_typeof();
    ::TYPES[64] = ::g::Uno::Byte_typeof();
    ::TYPES[65] = ::g::Uno::SByte_typeof();
    ::TYPES[51] = ::g::Fuse::IArray_typeof();
    type->SetFields(0,
        ::TYPES[52/*Uno.Collections.Dictionary<Uno.Type, Fuse.Computer>*/], (uintptr_t)&::g::Fuse::Marshal::_computers_, uFieldFlagsStatic,
        ::TYPES[53/*Uno.Collections.List<Fuse.Marshal.IConverter>*/], (uintptr_t)&::g::Fuse::Marshal::_converters_, uFieldFlagsStatic);
}
...
bool Marshal::CanConvertClass(uType* t)
{
    ...
    for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        if (Marshal__IConverter::CanConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret4), ret4)), ::TYPES[54/*Fuse.Marshal.IConverter*/]), t))
            return true;
...
::g::Uno::UX::Size Marshal::StringToSize(uString* o)
{
    ...
    if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[57/*"%"*/]))
    {
        unit = 4;
    ...
    else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[59/*"px"*/]))
    {
        unit = 3;
        s = ::g::Uno::String::Substring1(uPtr(s), 0, uPtr(s)->Length() - 2);
    }
    ...
    if (!::g::Uno::Float::TryParse(s, &v))
        U_THROW(::g::Fuse::MarshalException::New4(o, ::TYPES[59/*Uno.UX.Size*/]));
...
::g::Uno::UX::Size2 Marshal::StringToSize2(uString* o)
{
    ...
    if (::g::Uno::String::Contains(uPtr(o), ::STRINGS[50/*","*/]))
    {
        uArray* p = ::g::Uno::String::Split(uPtr(o), uArray::Init<int>(::TYPES[55/*char[]*/], 1, ','));
...
bool Marshal::ToBool(uObject* v)
{
    ...
    else if (uIs(v, ::TYPES[29/*string*/]))
    {
        uString* s = uCast<uString*>(v, ::TYPES[29/*string*/]);

        if (::g::Uno::String::op_Equality(s, ::STRINGS[55/*"true"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[60/*"True"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[56/*"false"*/]))
            return false;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[61/*"False"*/]))
            return false;
    }
...
bool Marshal::ToDouble1(uObject* v, double* res)
{
    ...
    else if (uIs(v, ::TYPES[44/*float*/]))
    {
        *res = (double)uUnbox<float>(::TYPES[44/*float*/], v);
        ...
        return Marshal::ToDouble2(uCast<uString*>(v, ::TYPES[29/*string*/]), res);
    else if (uIs(v, ::TYPES[45/*int*/]))
    {
        *res = (double)uUnbox<int>(::TYPES[45/*int*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[56/*float2*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float2>(::TYPES[56/*float2*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[57/*float3*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float3>(::TYPES[57/*float3*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[58/*float4*/]))
    {
        *res = (double)uUnbox< ::g::Uno::Float4>(::TYPES[58/*float4*/], v).X;
        return true;
    }
    else if (uIs(v, ::TYPES[59/*Uno.UX.Size*/]))
    {
        *res = (double)uUnbox< ::g::Uno::UX::Size>(::TYPES[59/*Uno.UX.Size*/], v).Value;
        return true;
    }
    else if (uIs(v, ::TYPES[60/*Uno.UX.Size2*/]))
    {
        ::g::Uno::UX::Size2 s = uUnbox< ::g::Uno::UX::Size2>(::TYPES[60/*Uno.UX.Size2*/], v);
        ::g::Uno::UX::Size x = s.X;
        *res = (double)x.Value;
        return true;
    }
    else if (uIs(v, ::TYPES[61/*uint*/]))
    {
        *res = (double)uUnbox<uint32_t>(::TYPES[61/*uint*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[62/*short*/]))
    {
        *res = (double)uUnbox<int16_t>(::TYPES[62/*short*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[63/*ushort*/]))
    {
        *res = (double)uUnbox<uint16_t>(::TYPES[63/*ushort*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[64/*byte*/]))
    {
        *res = (double)uUnbox<uint8_t>(::TYPES[64/*byte*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[65/*sbyte*/]))
    {
        *res = (double)uUnbox<int8_t>(::TYPES[65/*sbyte*/], v);
        return true;
    }
...
::g::Uno::Float2 Marshal::ToFloat2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[56/*float2*/]))
        return uUnbox< ::g::Uno::Float2>(::TYPES[56/*float2*/], o);
    else
...
::g::Uno::Float3 Marshal::ToFloat3(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[57/*float3*/]))
        return uUnbox< ::g::Uno::Float3>(::TYPES[57/*float3*/], o);
    else
...
::g::Uno::Float4 Marshal::ToFloat4(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[58/*float4*/]))
        return uUnbox< ::g::Uno::Float4>(::TYPES[58/*float4*/], o);
    else if (uIs(o, ::TYPES[57/*float3*/]))
    {
        ::g::Uno::Float3 f = uUnbox< ::g::Uno::Float3>(::TYPES[57/*float3*/], o);
        return ::g::Uno::Float4__New2(f.X, f.Y, f.Z, 1.0f);
    }
    else if (uIs(o, ::TYPES[56/*float2*/]))
    {
        ::g::Uno::Float2 f1 = uUnbox< ::g::Uno::Float2>(::TYPES[56/*float2*/], o);
        return ::g::Uno::Float4__New2(f1.X, f1.Y, f1.X, f1.Y);
    }
    else if (uIs(o, ::TYPES[29/*string*/]))
    {
        uString* s = uCast<uString*>(o, ::TYPES[29/*string*/]);

        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[62/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }
    else if (uIs(o, ::TYPES[59/*Uno.UX.Size*/]))
    {
        ::g::Uno::UX::Size s1 = uUnbox< ::g::Uno::UX::Size>(::TYPES[59/*Uno.UX.Size*/], o);
        return ::g::Uno::Float4__New1(s1.Value);
    }
    else if (uIs(o, ::TYPES[60/*Uno.UX.Size2*/]))
    {
        ::g::Uno::UX::Size2 s2 = uUnbox< ::g::Uno::UX::Size2>(::TYPES[60/*Uno.UX.Size2*/], o);
    ...
    U_THROW(::g::Fuse::MarshalException::New4(o, ::TYPES[58/*float4*/]));
}
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[59/*Uno.UX.Size*/]))
        return uUnbox< ::g::Uno::UX::Size>(::TYPES[59/*Uno.UX.Size*/], o);
    else if (uIs(o, ::TYPES[60/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[60/*Uno.UX.Size2*/], o).X;
    else if (uIs(o, ::TYPES[29/*string*/]))
        return Marshal::StringToSize(uCast<uString*>(o, ::TYPES[29/*string*/]));
    else
...
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[60/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[60/*Uno.UX.Size2*/], o);
    else if (uIs(o, ::TYPES[59/*Uno.UX.Size*/]))
        return ::g::Uno::UX::Size2__New1(uUnbox< ::g::Uno::UX::Size>(::TYPES[59/*Uno.UX.Size*/], o), uUnbox< ::g::Uno::UX::Size>(::TYPES[59/*Uno.UX.Size*/], o));
    else if (uIs(o, ::TYPES[29/*string*/]))
        return Marshal::StringToSize2(uCast<uString*>(o, ::TYPES[29/*string*/]));
    else
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[29/*string*/]))
    {
        *res = ::g::Uno::Object::ToString(uPtr(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[92/*Uno.UX.Selector*/]))
    {
        *res = uBox(::TYPES[92/*Uno.UX.Selector*/], ::g::Uno::UX::Selector__op_Implicit(::g::Uno::Object::ToString(uPtr(o))));
        return true;
    }
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[59/*Uno.UX.Size*/]))
    {
        *res = uBox(::TYPES[59/*Uno.UX.Size*/], Marshal::ToSize(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[60/*Uno.UX.Size2*/]))
    {
        *res = uBox(::TYPES[60/*Uno.UX.Size2*/], Marshal::ToSize2(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[56/*float2*/]))
    {
        *res = uBox(::TYPES[56/*float2*/], Marshal::ToFloat2(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[57/*float3*/]))
    {
        *res = uBox(::TYPES[57/*float3*/], Marshal::ToFloat3(o));
        return true;
    }
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[58/*float4*/]))
    {
        *res = uBox(::TYPES[58/*float4*/], Marshal::ToFloat4(o));
        return true;
    }
    else if (::g::Uno::Type::IsEnum(uPtr(t)) && uIs(o, ::TYPES[29/*string*/]))
    {
        *res = ::g::Uno::Enum::Parse(t, uCast<uString*>(o, ::TYPES[29/*string*/]));
        return true;
    }
    else
        ...
        for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        {
            uObject* c = Marshal__IConverter::TryConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret15), ret15)), ::TYPES[54/*Fuse.Marshal.IConverter*/]), t, o);
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[63/*"Cannot conv...*/], o), ::STRINGS[64/*"' to target...*/]), t), ::STRINGS[65/*"'"*/]), diagnosticSource, ::STRINGS[66/*"/Users/kits...*/], 654, ::STRINGS[67/*"TryConvertTo"*/], NULL);
...
{
    ::STRINGS[63] = uString::Const("Cannot convert '");
    ::STRINGS[68] = uString::Const("' to required target type '");
    ::STRINGS[65] = uString::Const("'");
    type->SetFields(3);
}
...
{
    ctor_1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[63/*"Cannot conv...*/], v), ::STRINGS[68/*"' to requir...*/]), t), ::STRINGS[65/*"'"*/]));
}
...
{
    ::TYPES[5] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[66] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof(), NULL);
    type->SetFields(0,
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyDown(uDelegate::New(::TYPES[66/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyUp(uDelegate::New(::TYPES[66/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
}
...
{
    NameRegistry::_nameToObj_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[67/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/]));
    NameRegistry::_names_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[68/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/]));
    NameRegistry::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[69/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/]));
}

static void NameRegistry_build(uType* type)
{
    ::TYPES[67] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), NULL);
    ::TYPES[68] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::UX::Selector_typeof(), NULL);
    ::TYPES[69] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL), NULL);
    ::TYPES[70] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL);
    ::TYPES[71] = ::g::Fuse::INameListener_typeof();
    ::TYPES[72] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::TYPES[70/*Uno.Collections.List<Fuse.INameListener>*/], NULL);
    ::TYPES[73] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[69/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/], (uintptr_t)&::g::Fuse::NameRegistry::_listeners_, uFieldFlagsStatic,
        ::TYPES[68/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/], (uintptr_t)&::g::Fuse::NameRegistry::_names_, uFieldFlagsStatic,
        ::TYPES[67/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/], (uintptr_t)&::g::Fuse::NameRegistry::_nameToObj_, uFieldFlagsStatic);
}
...
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[70/*Uno.Collections.List<Fuse.INameListener>*/]));
...
void NameRegistry::NotifyNameChanged(::g::Fuse::Node* obj, ::g::Uno::UX::Selector name)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret12), ret12))
        ...
        for (array2 = (uArray*)uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(NameRegistry::_listeners()), uCRef(name), &ret13), ret13))->ToArray(), index3 = 0, length4 = uPtr(array2)->Length(); index3 < length4; ++index3)
        {
            ...
            ::g::Fuse::INameListener::OnNameChanged(uInterface(uPtr(listener), ::TYPES[71/*Fuse.INameListener*/]), obj, name);
        }
}
...
void NameRegistry::RemoveListener(uObject* listener)
{
    ...
    for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(NameRegistry::_listeners())->Values()), &ret14), ret14); enum1.MoveNext(::TYPES[72/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* list = enum1.Current(::TYPES[72/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>.ValueCollection.Enumerator*/]);
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), &ret24), ret24))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj()), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Fuse.Node>*/]));
...
{
    Node::_emptyBindings_ = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[74/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Binding>*/], uArray::New(::TYPES[75/*Fuse.Binding[]*/], 0)));
    Node::_dataListeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[76/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/]));
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[77/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::TYPES[78/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[69/*"_createWatc...*/], uDelegate::New(::TYPES[79/*Uno.Func<Fuse.Scripting.Context, Fuse.Node, object[], object>*/], (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[78/*Fuse.Scripting.ScriptMethod<Fuse.Node>*/], ::STRINGS[70/*"_destroyWat...*/], uDelegate::New(::TYPES[80/*Uno.Action<Fuse.Scripting.Context, Fuse.Node, object[]>*/], (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(::STRINGS[71/*"findData"*/], 1, ::STRINGS[72/*"function(ke...*/])));
}

static void Node_build(uType* type)
{
    ::STRINGS[69] = uString::Const("_createWatcher");
    ::STRINGS[70] = uString::Const("_destroyWatcher");
    ::STRINGS[71] = uString::Const("findData");
    ::STRINGS[72] = uString::Const("function(key) { return Observable._getDataObserver(this, key); }");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[73] = uString::Const("Incomplete or duplicate rooting: ");
    ::STRINGS[74] = uString::Const("/");
    ::STRINGS[75] = uString::Const("Node is already rooted with a different parent");
    ::STRINGS[76] = uString::Const("Invalid RootStage post rooting: ");
    ::STRINGS[77] = uString::Const(", Name: ");
    ::STRINGS[78] = uString::Const("Incomplete or duplicate unrooting: ");
    ::TYPES[74] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[75] = ::g::Fuse::Binding_typeof()->Array();
    ::TYPES[76] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL), NULL);
    ::TYPES[28] = ::g::Uno::Type_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[78] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[79] = ::g::Uno::Func3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[80] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[29] = ::g::Uno::String_typeof();
    ::TYPES[81] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[82] = Node__DataWatcher_typeof();
    ::TYPES[83] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[84] = ::g::Fuse::Binding_typeof();
    ::TYPES[85] = ::g::Uno::Collections::List_typeof()->MakeType(Node__IDataListener_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::IObject_typeof();
    ::TYPES[86] = Node__ISubtreeDataProvider_typeof();
    ::TYPES[87] = Node__IDataEnumerator_typeof();
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(type, NULL);
    ::TYPES[88] = Node__ISiblingDataProvider_typeof();
    ::TYPES[89] = ::g::Uno::Collections::IList_typeof()->MakeType(type, NULL);
    ::TYPES[90] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[84/*Fuse.Binding*/], NULL);
    ::TYPES[91] = Node__IDataListener_typeof();
    ::TYPES[92] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[93] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[84/*Fuse.Binding*/], NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[84/*Fuse.Binding*/], NULL), offsetof(Node_type, interface0),
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[84/*Fuse.Binding*/], NULL), offsetof(Node_type, interface4),
        ::TYPES[93/*Uno.Collections.IEnumerable<Fuse.Binding>*/], offsetof(Node_type, interface5));
    type->SetFields(1,
        uObject_typeof(), offsetof(::g::Fuse::Node, _bindings), 0,
        ::TYPES[92/*Uno.UX.Selector*/], offsetof(::g::Fuse::Node, _name), 0,
        ::TYPES[10/*Fuse.Visual*/], offsetof(::g::Fuse::Node, _parent), 0,
        ...
        ::TYPES[76/*Uno.Collections.Dictionary<string, Uno.Collections.List<Fuse.Node.IDataListener>>*/], (uintptr_t)&::g::Fuse::Node::_dataListeners_, uFieldFlagsStatic,
        ::TYPES[93/*Uno.Collections.IEnumerable<Fuse.Binding>*/], (uintptr_t)&::g::Fuse::Node::_emptyBindings_, uFieldFlagsStatic,
...
void Node__ToString_fn(Node* __this, uString** __retval)
{
    ...
    if (!__this->Name().IsNull())
        return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((::g::Uno::Object__ToString_fn(__this, &ret12), ret12), ::STRINGS[77/*", Name: "*/]), __this->Name().ToString(::TYPES[92/*Uno.UX.Selector*/])), void();
    else
...
void Node__UnoCollectionsICollectionFuseBindingget_Count_fn(Node* __this, int* __retval)
{
    ...
    if (uIs((uObject*)__this->_bindings, ::TYPES[84/*Fuse.Binding*/]))
...
void Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn(Node* __this, uObject** __retval)
{
    ...
    if (__this->_bindings == NULL)
        return *__retval = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Node::_emptyBindings()), ::TYPES[93/*Uno.Collections.IEnumerable<Fuse.Binding>*/])), void();

    if (uIs((uObject*)__this->_bindings, ::TYPES[84/*Fuse.Binding*/]))
        __this->MakeBindingList(NULL);

    return *__retval = uBox(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[84/*Fuse.Binding*/], NULL), (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->BindingList()), &ret15), ret15)), void();
}
...
void Node::Add(::g::Fuse::Binding* item)
{
    if (_bindings == NULL)
        _bindings = item;
    else if (uIs((uObject*)_bindings, ::TYPES[84/*Fuse.Binding*/]))
...
void Node::AddDataListener(uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[85/*Uno.Collections.List<Fuse.Node.IDataListener>*/]);
...
{
    return uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[84/*Fuse.Binding*/]);
}

// private Uno.Collections.List<Fuse.Binding> get_BindingList() [instance] :2216
::g::Uno::Collections::List* Node::BindingList()
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[90/*Uno.Collections.List<Fuse.Binding>*/]);
}
...
{
    uArray* newKeys = NULL;
    uObject* newObj = uAs<uObject*>(newData, ::TYPES[13/*Fuse.IObject*/]);

    if (newObj != NULL)
    {
        newKeys = ::g::Fuse::IObject::Keys(uInterface(uPtr(newObj), ::TYPES[13/*Fuse.IObject*/]));

        for (int i = 0; i < uPtr(newKeys)->Length(); i++)
            OnDataChanged(uPtr(newKeys)->Strong<uString*>(i), ::g::Fuse::IObject::Item(uInterface(uPtr(newObj), ::TYPES[13/*Fuse.IObject*/]), uPtr(newKeys)->Strong<uString*>(i)));
    }
    else if (newData != NULL)
        OnDataChanged(::STRINGS[8/*""*/], newData);

    uObject* oldObj = uAs<uObject*>(oldData, ::TYPES[13/*Fuse.IObject*/]);

    if (oldObj != NULL)
    {
        uArray* keys = ::g::Fuse::IObject::Keys(uInterface(uPtr(oldObj), ::TYPES[13/*Fuse.IObject*/]));
...
void Node::EnumerateData(uObject* e)
{
    ...
    while (n != NULL)
    {
        ...
        if (np != NULL)
        {
            uObject* subdp = uAs<uObject*>(np, ::TYPES[86/*Fuse.Node.ISubtreeDataProvider*/]);

            if (subdp != NULL)
            {
                uObject* data = Node__ISubtreeDataProvider::GetData(uInterface(uPtr(subdp), ::TYPES[86/*Fuse.Node.ISubtreeDataProvider*/]), n);

                if ((data != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[87/*Fuse.Node.IDataEnumerator*/]), data))
                    return;
            }
        }

        ::g::Fuse::Visual* p = uAs< ::g::Fuse::Visual*>(np, ::TYPES[10/*Fuse.Visual*/]);

        if (p != NULL)

            for (int i = ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])) - 1; i >= 0; i--)
            {
                uObject* sibdp = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(p)->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[88/*Fuse.Node.ISiblingDataProvider*/]);

                if (sibdp != NULL)
                {
                    uObject* data1 = Node__ISiblingDataProvider::Data(uInterface(uPtr(sibdp), ::TYPES[88/*Fuse.Node.ISiblingDataProvider*/]));

                    if ((data1 != NULL) && !Node__IDataEnumerator::NextData(uInterface(uPtr(e), ::TYPES[87/*Fuse.Node.IDataEnumerator*/]), Node__ISiblingDataProvider::Data(uInterface(sibdp, ::TYPES[88/*Fuse.Node.ISiblingDataProvider*/]))))
                        return;
                }
            }
...
void Node::Insert(int index, ::g::Fuse::Binding* item)
{
    ...
    {
        if (uIs((uObject*)_bindings, ::TYPES[84/*Fuse.Binding*/]))
...
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[90/*Uno.Collections.List<Fuse.Binding>*/]);
    ::g::Fuse::Binding* oldItem = uAs< ::g::Fuse::Binding*>(_bindings, ::TYPES[84/*Fuse.Binding*/]);
...
void Node::OnDataChanged(uString* key, uObject* newValue)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(Node::_dataListeners()), key, (void**)(&listeners), &ret6), ret6))
        ...
        for (int i = 0; i < uPtr(listeners)->Count(); i++)
            Node__IDataListener::OnDataChanged(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(listeners), uCRef<int>(i), &ret7), ret7)), ::TYPES[91/*Fuse.Node.IDataListener*/]));
}
...
bool Node::Remove(::g::Fuse::Binding* item)
{
    ...
    if ((_bindings == NULL) || uIs((uObject*)_bindings, ::TYPES[84/*Fuse.Binding*/]))
        return false;
...
{
    if (_rootStage != 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[73/*"Incomplete ...*/], this), ::STRINGS[74/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));

    if (_parent != NULL)
    {
        if (_parent != parent)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[75/*"Node is alr...*/]));
        else
            return;
    }
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[76/*"Invalid Roo...*/], this), ::STRINGS[74/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
}
...
void Node::UnrootInternal()
{
    ...
    if (_rootStage != 2)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[78/*"Incomplete ...*/], this), ::STRINGS[74/*"/"*/]), ::g::Uno::UX::Selector__op_Implicit1(Name()))));
...
{
    Node_typeof()->Init();
    uString* key = uCast<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[29/*string*/]);
    ::g::Fuse::Scripting::Function* callback = uCast< ::g::Fuse::Scripting::Function*>(args->Strong<uObject*>(1), ::TYPES[81/*Fuse.Scripting.Function*/]);
...
{
    Node_typeof()->Init();
    Node__DataWatcher* watcher = uCast<Node__DataWatcher*>(uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[83/*Fuse.Scripting.External*/]))->Object, ::TYPES[82/*Fuse.Node.DataWatcher*/]);
...
{
    ::STRINGS[79] = uString::Const("AddContent called prior to having a Parent");
    ::STRINGS[3] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.5/$.uno");
    ::STRINGS[80] = uString::Const("AddContent");
    ::STRINGS[81] = uString::Const("Could not locate node in parent, content not added");
    ::TYPES[94] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[95] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[96] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[97] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Node_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Node_type, interface2),
    ...
    type->SetFields(12,
        ...
        ::TYPES[97/*Uno.Collections.RootableList<Fuse.Node>*/], offsetof(::g::Fuse::NodeGroupBase, _nodes), 0,
...
void NodeGroupBase__OnRooted_fn(NodeGroupBase* __this)
{
    ...
    if (__this->_nodes != NULL)
        uPtr(__this->_nodes)->Subscribe(uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeAdded_fn, __this), uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeRemoved_fn, __this));

    if (__this->_resources != NULL)
        uPtr(__this->_resources)->Subscribe(uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceAdded_fn, __this), uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)NodeGroupBase__OnResourceRemoved_fn, __this));
}
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[79/*"AddContent ...*/], this, ::STRINGS[3/*"/Users/kits...*/], 3223, ::STRINGS[80/*"AddContent"*/]);
        return;
    }
    ...
    if (_resources != NULL)
        ...
        for (int i = 0; i < uPtr(_resources)->Count(); i++)
            ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[94/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::RootableList__get_Item_fn(uPtr(_resources), uCRef<int>(i), &ret2), ret2));

    if ((_nodes == NULL) || (uPtr(_nodes)->Count() == 0))
        return;

    int where = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[95/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), this, &ret3), ret3);

    if (where == -1)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[81/*"Could not l...*/], this, ::STRINGS[3/*"/Users/kits...*/], 3242, ::STRINGS[80/*"AddContent"*/]);
        return;
    }
...
uObject* NodeGroupBase::Nodes()
{
    if (_nodes == NULL)
    {
        _nodes = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[97/*Uno.Collections.RootableList<Fuse.Node>*/]));

        if (IsRootingCompleted())
            uPtr(_nodes)->Subscribe(uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeAdded_fn, this), uDelegate::New(::TYPES[8/*Uno.Action<Fuse.Node>*/], (void*)NodeGroupBase__OnNodeRemoved_fn, this));
    }
...
{
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[94/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r);
}
...
void NodeGroupBase::OnResourceRemoved(::g::Uno::UX::Resource* r)
{
    ...
    if (IsRootingCompleted() && UseContent())
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[94/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), r, &ret5);
}
...
void NodeGroupBase::RemoveContent()
{
    ...
    if (_resources != NULL)
        ...
        for (int i = 0; i < uPtr(_resources)->Count(); i++)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Resources()), ::TYPES[94/*Uno.Collections.ICollection<Uno.UX.Resource>*/]), (::g::Uno::Collections::RootableList__get_Item_fn(uPtr(_resources), uCRef<int>(i), &ret7), ret7), &ret6);
...
::g::Uno::Float4x4 OrthographicFrustum::GetViewTransform(uObject* viewport)
{
    ...
    ::g::Uno::Float2 viewSize = _hasSize ? Size() : ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(viewport), ::TYPES[25/*Fuse.ICommonViewport*/]));
...
{
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[82/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[82] = uString::Const("Parameter");
...
{
    ::TYPES[98] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[99] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[100] = ::g::Fuse::PlacedHandler_typeof();
    type->SetInterfaces(
...
{
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[99/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[98/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[98/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[100/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[99/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
...
{
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[98/*Fuse.IActualPlacement*/])), ::TYPES[98/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[100/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[99/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
...
{
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[101] = ::g::Fuse::ITransformMode_typeof();
    type->SetInterfaces(
...
void RelativeTransform::CheckSubscription(bool fromRooted)
{
    ...
    ClearSubscription();
    _subscription = ::g::Fuse::ITransformMode::Subscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[101/*Fuse.ITransformMode*/])), ::TYPES[101/*Fuse.ITransformMode*/]), (uObject*)this);
...
void RelativeTransform::ClearSubscription()
{
    ...
    {
        ::g::Fuse::ITransformMode::Unsubscribe(uInterface(uPtr(uAs<uObject*>(RelativeTo(), ::TYPES[101/*Fuse.ITransformMode*/])), ::TYPES[101/*Fuse.ITransformMode*/]), (uObject*)this, _subscription);
        _subscription = NULL;
    }
}
...
// private sealed class App.RootViewHost :160
// {
...
// public generated RootViewHost() :160
void App__RootViewHost__ctor__fn(App__RootViewHost* __this)
{
    __this->ctor_();
}

// private void Fuse.Controls.INativeViewRoot.Add(Fuse.Controls.Native.ViewHandle handle) :162
...
// private void Fuse.Controls.INativeViewRoot.Remove(Fuse.Controls.Native.ViewHandle handle) :163
...
// public generated RootViewHost New() :160
void App__RootViewHost__New1_fn(App__RootViewHost** __retval)
{
    *__retval = App__RootViewHost::New1();
}

// public generated RootViewHost() [instance] :160
void App__RootViewHost::ctor_()
{
}

// public generated RootViewHost New() [static] :160
...
{
    ::TYPES[102] = ::g::Fuse::IFrame_typeof();
    ::TYPES[26] = ::g::Uno::EventHandler_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[89] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[103] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/], offsetof(RootViewport_type, interface6),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(RootViewport_type, interface7),
        ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(RootViewport_type, interface8),
    ...
    type->SetFields(54,
        ::TYPES[102/*Fuse.IFrame*/], offsetof(::g::Fuse::RootViewport, _frame), 0,
        ...
        ::TYPES[103/*Uno.Action<float2>*/], offsetof(::g::Fuse::RootViewport, Resized1), 0);
}
...
void RootViewport__Draw_fn(RootViewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret3), ret3), ::TYPES[10/*Fuse.Visual*/]);
        uPtr(v)->Draw(dc);
    }
}
...
void RootViewport::ctor_4(uObject* frame)
{
    ...
    ctor_2();
    _frame = frame;
    ::g::Fuse::IFrame::add_FrameChanged(uInterface(uPtr(_frame), ::TYPES[102/*Fuse.IFrame*/]), uDelegate::New(::TYPES[26/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
...
void RootViewport::EstablishSizeInternals()
{
    ...
    _pixelSize = ::g::Fuse::IFrame::Size(uInterface(uPtr(_frame), ::TYPES[102/*Fuse.IFrame*/]));
...
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Resized1, value), ::TYPES[103/*Uno.Action<float2>*/]);
}
...
{
    Resized1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Resized1, value), ::TYPES[103/*Uno.Action<float2>*/]);
}
...
{
    ::TYPES[104] = ::g::Fuse::IScalingMode_typeof();
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[104/*Fuse.IScalingMode*/]), this);
}
...
{
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[99/*Fuse.ITransformRelative*/])), ::TYPES[98/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[98/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[100/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[99/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[99/*Fuse.ITransformRelative*/]));
}
...
{
    ::TYPES[105] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[106] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Stage, HasListenersRemoved), 0,
        ::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Listeners), 0,
        ::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, Onces), 0,
        ::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(::g::Fuse::Stage, OncesPending), 0,
        ::TYPES[106/*Uno.Collections.List<Fuse.UpdateAction>*/], offsetof(::g::Fuse::Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[105/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    PhaseDeferredActions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[106/*Uno.Collections.List<Fuse.UpdateAction>*/]));
...
static void Transform_build(uType* type)
{
    ...
    type->SetFields(12,
        ::TYPES[107/*Uno.Action<Fuse.Transform>*/], offsetof(::g::Fuse::Transform, MatrixChanged1), 0);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[107/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[107/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    ::TYPES[108] = ::g::Fuse::ITranslationMode_typeof();
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[108/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[108/*Fuse.ITranslationMode*/]), __this);
...
::g::Uno::Float3 TranslationModes::SizeOf(::g::Fuse::Node* node)
{
    ...
    uObject* isz = uAs<uObject*>(node, ::TYPES[98/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[98/*Fuse.IActualPlacement*/]));
}
// }
...
{
    ::TYPES[109] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
        ...
        ::TYPES[109/*Fuse.IUpdateListener*/], offsetof(::g::Fuse::UpdateListener, update), 0);
}
...
void UpdateListener::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[109/*Fuse.IUpdateListener*/]));
}
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[110/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[111/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[111/*Uno.Collections.List<Uno.Action>*/]));
...
{
    ::STRINGS[83] = uString::Const("no Action found to remove");
    ::TYPES[110] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof(), NULL);
    ::TYPES[111] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Exception_typeof();
    ::TYPES[112] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[3/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ...
        ::TYPES[111/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[111/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&::g::Fuse::UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
        ::TYPES[110/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&::g::Fuse::UpdateManager::_stages_, uFieldFlagsStatic,
...
// internal static Fuse.UpdateStage get_CurrentStage() :3387
...
void UpdateManager::ProcessDeferredActions(::g::Fuse::Stage* stage, ::g::Uno::Collections::List** _exceptions)
{
    ...
    for (; stage->PhaseDeferredActionsAt < uPtr(stage->PhaseDeferredActions)->Count(); ++stage->PhaseDeferredActionsAt)
        ...
        catch (const uThrowable& __t)
        {
            ...
            if (*_exceptions == NULL)
                *_exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[112/*Uno.Collections.List<Uno.Exception>*/]);
...
void UpdateManager::RemoveAction(uObject* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, NULL, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[83/*"no Action f...*/]));
...
// internal static Fuse.UpdateStage get_CurrentStage() [static] :3387
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.5/$.uno
// ------------------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[77/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[113/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[84/*"raise"*/], uDelegate::New(::TYPES[114/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}

static void UserEvent_build(uType* type)
{
    ::STRINGS[84] = uString::Const("raise");
    ::STRINGS[85] = uString::Const("UserEvent requires a Name");
    ::STRINGS[86] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.5/$.uno");
    ::STRINGS[87] = uString::Const("OnRooted");
    ::STRINGS[88] = uString::Const("Raise must be called with zero arguments, or one argument defining the arguments to the event");
    ::STRINGS[89] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[90] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[91] = uString::Const("Raise");
    ::TYPES[28] = ::g::Uno::Type_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[113] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[114] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[115] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[116] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[89] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[85/*"UserEvent r...*/], __this, ::STRINGS[86/*"/Users/kits...*/], 654, ::STRINGS[87/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[90/*"Trying to R...*/], this, ::STRINGS[86/*"/Users/kits...*/], 701, ::STRINGS[91/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[88/*"Raise must ...*/], n, ::STRINGS[86/*"/Users/kits...*/], 421, ::STRINGS[84/*"raise"*/], NULL);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[115/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[89/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[86/*"/Users/kits...*/], 428, ::STRINGS[84/*"raise"*/], NULL);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[116/*Uno.Collections.Dictionary<string, object>*/]);
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            {
                UserEvent* ue = uAs<UserEvent*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret2), ret2), UserEvent_typeof());
...
{
    UserEventDispatch::_userEvents_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[117/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/]));
}

static void UserEventDispatch_build(uType* type)
{
    ::TYPES[117] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), type, NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[118] = ::g::Fuse::UserEventHandler_typeof();
    type->SetFields(0,
        ::g::Uno::UX::Selector_typeof(), offsetof(::g::Fuse::UserEventDispatch, _Name), 0,
        ::TYPES[118/*Fuse.UserEventHandler*/], offsetof(::g::Fuse::UserEventDispatch, Raised1), 0,
        ::TYPES[117/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/], (uintptr_t)&::g::Fuse::UserEventDispatch::_userEvents_, uFieldFlagsStatic);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Raised1, value), ::TYPES[118/*Fuse.UserEventHandler*/]);
}
...
{
    Raised1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Raised1, value), ::TYPES[118/*Fuse.UserEventHandler*/]);
}
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::_isEnabledName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[92/*"IsEnabled"*/]);
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[82/*"Parameter"*/]);
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[77/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::TYPES[119/*Fuse.Scripting.ScriptProperty<Fuse.Visual, string>*/], ::STRINGS[82/*"Parameter"*/], uDelegate::New(::TYPES[120/*Uno.Func<Fuse.Visual, Uno.UX.Property<string>>*/], (void*)Visual__getParameterProperty_fn), ::STRINGS[93/*".notNull()....*/]), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[94/*"onParameter...*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[121/*Fuse.Scripting.ScriptMethod<Fuse.Visual>*/], ::STRINGS[95/*"bringIntoView"*/], uDelegate::New(::TYPES[122/*Uno.Action<Fuse.Scripting.Context, Fuse.Visual, object[]>*/], (void*)Visual__bringIntoView_fn), 2)));
}

static void Visual_build(uType* type)
{
    ::STRINGS[92] = uString::Const("IsEnabled");
    ::STRINGS[82] = uString::Const("Parameter");
    ::STRINGS[93] = uString::Const(".notNull().parseJson()");
    ::STRINGS[94] = uString::Const("onParameterChanged");
    ::STRINGS[95] = uString::Const("bringIntoView");
    ::STRINGS[96] = uString::Const("index");
    ::STRINGS[97] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[98] = uString::Const("Invalid call to RearrangeMarginBox");
    ::TYPES[28] = ::g::Uno::Type_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[119] = ::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(type, ::g::Uno::String_typeof(), NULL);
    ::TYPES[120] = ::g::Uno::Func1_typeof()->MakeType(type, ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), NULL);
    ...
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[123] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[124] = ::g::Fuse::Scripting::IScriptObject_typeof();
    ::TYPES[15] = uObject_typeof()->Array();
    ::TYPES[125] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[89] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[126] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(type, NULL);
    ::TYPES[127] = ::g::Fuse::Transform_typeof();
    ::TYPES[128] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[129] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[130] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(uObject_typeof(), Visual__InteractionItem_typeof(), NULL);
    ::TYPES[131] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[132] = ::g::Uno::Comparison_typeof()->MakeType(type, NULL);
    ::TYPES[133] = ::g::Fuse::FastProperty1Link1_typeof();
    ::TYPES[134] = ::g::Fuse::FastProperty2Link1_typeof();
    ::TYPES[11] = ::g::Fuse::IViewport_typeof();
    ...
    ::TYPES[81] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[142] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[143] = ::g::Fuse::ITemplateObserver_typeof();
    ::TYPES[107] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[127/*Fuse.Transform*/], NULL);
    ::TYPES[25] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[144] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof(), NULL);
    ::TYPES[145] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[96] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[146] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[94] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[147] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[148] = type->MakeMethod(3/*FirstChild<Fuse.Visual>*/, type, NULL);
    ::TYPES[149] = ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(type, NULL);
    ::TYPES[150] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[133/*Fuse.FastProperty1Link`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[134/*Fuse.FastProperty2Link`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL));
    ...
    type->MethodTypes[7]->SetPrecalc(
        ::TYPES[133/*Fuse.FastProperty1Link`1*/]->MakeType(type->MethodTypes[7]->U(0), NULL));
    type->MethodTypes[8]->SetPrecalc(
        ::TYPES[134/*Fuse.FastProperty2Link`1*/]->MakeType(type->MethodTypes[8]->U(0), NULL));
    ...
    type->SetInterfaces(
        ...
        ::TYPES[124/*Fuse.Scripting.IScriptObject*/], offsetof(Visual_type, interface1),
        ...
        ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/], offsetof(Visual_type, interface6),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(Visual_type, interface7),
        ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(Visual_type, interface8),
    ...
    type->SetFields(12,
        ...
        ::TYPES[126/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/], offsetof(::g::Fuse::Visual, _interactions), 0,
        ...
        ::TYPES[123/*Uno.Collections.List<Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Visual, _parameterListeners), 0,
        ...
        ::TYPES[149/*Uno.Collections.RootableList<Uno.UX.Template>*/], offsetof(::g::Fuse::Visual, _templates), 0,
        ...
        ::TYPES[26/*Uno.EventHandler*/], offsetof(::g::Fuse::Visual, IsInteractingChanged1), 0,
        ::TYPES[150/*Fuse.RequestBringIntoViewHandler*/], offsetof(::g::Fuse::Visual, RequestBringIntoView1), 0,
        ::TYPES[26/*Uno.EventHandler*/], offsetof(::g::Fuse::Visual, ZOrderChanged1), 0,
...
// internal bool CalcAreChildrenFlat() :6136
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() :5746
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret34), ret34);
...
void Visual__OnChildRemoved_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    ...
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Node* n = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret35), ret35);
            uObject* obs = uAs<uObject*>(n, ::TYPES[141/*Fuse.IParentObserver*/]);
...
// protected void OnInvalidateWorldTransform() :7233
...
// internal Fuse.FastMatrix get_ParentWorldTransformInternal() :7283
...
void Visual__TryGetResource_fn(Visual* __this, uString* key, uDelegate* acceptor, uObject** resource, bool* __retval)
{
    ...
    if (__this->HasResources())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(resources), ::TYPES[94/*Uno.Collections.ICollection<Uno.UX.Resource>*/])); i++)
        {
            ::g::Uno::UX::Resource* r = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(resources), ::TYPES[147/*Uno.Collections.IList<Uno.UX.Resource>*/]), uCRef<int>(i), &ret46), ret46);
...
void Visual__UnoCollectionsICollectionFuseNodeClear_fn(Visual* __this)
{
    ...
    for (uObject* enum1 = (uObject*)__this->_children.GetEnumerator(::TYPES[137/*Fuse.Internal.MiniList<Fuse.Node>*/]); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[31/*Uno.Collections.IEnumerator*/])); )
    {
...
void Visual__VisitSubtree_fn(Visual* __this, uDelegate* action)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret51), ret51))->VisitSubtree(action);
}
...
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[123/*Uno.Collections.List<Fuse.Scripting.Function>*/]));

    ::g::Uno::Collections::List__Add_fn(uPtr(_parameterListeners), func);

    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        uObject* so = uAs<uObject*>(this, ::TYPES[124/*Fuse.Scripting.IScriptObject*/]);

        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[124/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter)));
    }
}
...
void Visual::BeginInteraction(uObject* id, uDelegate* cancelled)
{
    ...
    if (_interactions == NULL)
        _interactions = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[126/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>*/]));
...
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret10);
...
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    if (!IsRootingCompleted())
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret11);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret12), ret12))
        return;
...
void Visual::BringToFront(Visual* item)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<Visual*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(ZOrder()), &ret13), ret13); enum5.MoveNext(::TYPES[9/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
...
// internal bool CalcAreChildrenFlat() [instance] :6136
...
bool Visual::CalcIsLocalFlat()
{
    ...
    {
        ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret14), ret14), ::TYPES[127/*Fuse.Transform*/]);
...
void Visual::CancelInteractions(int how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[128/*Uno.Collections.List<object>*/]);

        for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uObject*>, Visual__InteractionItem> enum3 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(_interactions), &ret15), ret15); enum3.MoveNext(::TYPES[129/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]); )
        {
            ::g::Uno::Collections::KeyValuePair<uStrong<uObject*>, Visual__InteractionItem> i = enum3.Current(::TYPES[129/*Uno.Collections.Dictionary<object, Fuse.Visual.InteractionItem>.Enumerator*/]);
            ::g::Uno::Collections::List__Add_fn(uPtr(ids), i.Key(::TYPES[130/*Uno.Collections.KeyValuePair<object, Fuse.Visual.InteractionItem>*/]));
        }

        for (::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(ids, &ret16), ret16); enum4.MoveNext(::TYPES[131/*Uno.Collections.List<object>.Enumerator*/]); )
        {
            uObject* id = enum4.Current(::TYPES[131/*Uno.Collections.List<object>.Enumerator*/]);
...
void Visual::EnsureSortedZOrder()
{
    ...
    EnsureZOrder();
    uPtr(ZOrder())->Sort(uDelegate::New(::TYPES[132/*Uno.Comparison<Fuse.Visual>*/], (void*)Visual__ZOrderComparator_fn, this));
    _sortedZOrder = true;
...
::g::Fuse::Node* Visual::FirstChild(uType* __type)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
    {
        ::g::Fuse::Node* c = uAs< ::g::Fuse::Node*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret23), ret23), __types[0]);
...
Visual* Visual::FirstVisualChild()
{
    ...
    return (Visual*)FirstChild(::TYPES[148/*Fuse.Visual.FirstChild<Fuse.Visual>*/]);
}
...
// internal Fuse.Visual.HitTestTransformMode get_HitTestTransform() [instance] :5746
...
void Visual::InsertNodes(int index, uObject* items)
{
    ...
    if ((index < 0) || (index > ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]))))
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[96/*"index"*/]));

    while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(items), ::TYPES[31/*Uno.Collections.IEnumerator*/])))
        InsertCleanup((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[138/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret30), ret30));
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::IEnumerator::Reset(uInterface(uPtr(items), ::TYPES[31/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[31/*Uno.Collections.IEnumerator*/])))
            _children.Insert(::TYPES[137/*Fuse.Internal.MiniList<Fuse.Node>*/], index++, (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[138/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret31), ret31));

        ::g::Uno::Collections::IEnumerator::Reset(uInterface(items, ::TYPES[31/*Uno.Collections.IEnumerator*/]));

        while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[31/*Uno.Collections.IEnumerator*/])))
            OnAdded((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::TYPES[138/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret32), ret32));
    }
}
...
void Visual::InvalidateLayout(int reason)
{
    if (Visual::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[97/*"Layout was ...*/]));
...
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[26/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::TYPES[139/*Uno.EventArgs*/]));
}
...
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(IsInteractingChanged1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
{
    IsInteractingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(IsInteractingChanged1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
void Visual::OnAdded(::g::Fuse::Node* b)
{
    ...
    ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>(b, ::TYPES[127/*Fuse.Transform*/]);
...
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        uObject* rvl = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret33), ret33), ::TYPES[140/*Fuse.IBeginRemoveVisualListener*/]);
...
// protected void OnInvalidateWorldTransform() [instance] :7233
...
void Visual::OnParameterChanged()
{
    ...
    if (_parameterListeners != NULL)
    {
        ...
        if (so != NULL)
        {
            uObject* param = uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::TYPES[124/*Fuse.Scripting.IScriptObject*/])))->ParseJson(_parameter);

            for (int i = 0; i < uPtr(_parameterListeners)->Count(); i++)
                uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_parameterListeners), uCRef<int>(i), &ret37), ret37))->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, param));
        }
    }
...
void Visual::OnTemplatesChanged(::g::Uno::UX::Template* t)
{
    ...
    if (IsRootingCompleted())
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            uObject* to = uAs<uObject*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret38), ret38), ::TYPES[143/*Fuse.ITemplateObserver*/]);
...
{
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[107/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[107/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
// internal Fuse.FastMatrix get_ParentWorldTransformInternal() [instance] :7283
...
void Visual::PrependExplicitTransforms(::g::Fuse::FastMatrix* m)
{
    ...
    if (HasExplicitTransforms())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            ::g::Fuse::Transform* t = uAs< ::g::Fuse::Transform*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret40), ret40), ::TYPES[127/*Fuse.Transform*/]);
...
{
    if (!HasMarginBox())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[98/*"Invalid cal...*/]));
...
void Visual::RemoveAllChildren(uType* __type)
{
    ...
    while (i >= 0)
    {
        if (uIs((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret41), ret41), __types[0]))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), i);
...
uObject* Visual::Resources()
{
    ...
    {
        SetBit4(1);
        ::g::Uno::Collections::RootableList* list = (::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[145/*Uno.Collections.RootableList<Uno.UX.Resource>*/]);

        if (IsRootingCompleted())
            uPtr(list)->Subscribe(uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this));
...
void Visual::RootResources()
{
    ...
    if (HasResources())
    {
        ::g::Uno::Collections::RootableList* list = uCast< ::g::Uno::Collections::RootableList*>(Resources(), ::TYPES[145/*Uno.Collections.RootableList<Uno.UX.Resource>*/]);
        uPtr(list)->Subscribe(uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this), uDelegate::New(::TYPES[96/*Uno.Action<Uno.UX.Resource>*/], (void*)Visual__OnResourceChanged_fn, this));
...
{
    if (_templates != NULL)
        uPtr(_templates)->Subscribe(uDelegate::New(::TYPES[146/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[146/*Uno.Action<Uno.UX.Template>*/], (void*)Visual__OnTemplatesChanged_fn, this));
}
...
void Visual::SendToBack(Visual* item)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong<Visual*> > enum6 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(ZOrder()), &ret43), ret43); enum6.MoveNext(::TYPES[9/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
...
uObject* Visual::Templates()
{
    if (_templates == NULL)
    {
        _templates = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::TYPES[149/*Uno.Collections.RootableList<Uno.UX.Template>*/]));
...
void Visual::UpdateContextSnapToPixelsCache()
{
    ...
    if (newValue != SnapToPixels())
    {
        ...
        for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
        {
            Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret49), ret49), Visual_typeof());
...
void Visual::UpdateLayout()
{
    ...
    switch (_layoutDirty)
    {
        ...
        case 1:
        {
            for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
            {
                Visual* v = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Children()), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret50), ret50), Visual_typeof());
...
{
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ZOrderChanged1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
{
    ZOrderChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ZOrderChanged1, value), ::TYPES[26/*Uno.EventHandler*/]);
}
...
void Visual::AssignZOrder(uObject* nodes)
{
    Visual_typeof()->Init();
    ::g::Fuse::Node* ret9;
    uArray* current = uArray::Init<int>(::TYPES[125/*int[]*/], 4, 0, 0, 0, 0);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/])); i++)
    {
        Visual* visual = uAs<Visual*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[89/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret9), ret9), Visual_typeof());
...
{
    Visual_typeof()->Init();
    uPtr(v)->AddParameterChangedListener(uCast< ::g::Fuse::Scripting::Function*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[81/*Fuse.Scripting.Function*/]));
}
// }
...
{
    ::STRINGS[99] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[100] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Nodes/1.0.5/$.uno");
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[99/*"Invalid Rai...*/], 1, ::STRINGS[100/*"../../../Li...*/], 1014);
            return;
        }
    }
    ...
    for (int i = 0; i < uPtr(list)->Count(); ++i)
        uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret2), ret2))->Properties())->ForeachInList(_handle, handler, uArray::Init<uObject*>(::TYPES[15/*object[]*/], 2, (::g::Uno::Collections::List__get_Item_fn(uPtr(list), uCRef<int>(i), &ret3), ret3), args));
...
{
    ::STRINGS[101] = uString::Const("visual");
    type->SetFields(0,
...
void VisualEventArgs::ctor_1(::g::Fuse::Visual* visual)
{
    ...
    if (visual == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[101/*"visual"*/]));
...
{
    ::STRINGS[102] = uString::Const("Wrapped Exception");
    type->SetFields(3);
}
...
{
    ctor_2(::STRINGS[102/*"Wrapped Exc...*/], inner);
}
