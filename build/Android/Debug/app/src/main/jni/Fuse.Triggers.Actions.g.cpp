...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/triggers/actions/$.uno
// ---------------------------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Controls/1.0.5/triggers/$.uno
// -------------------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.5/actions/$.uno
// ------------------------------------------------------------------------------------------------
...
{
    ::TYPES[10] = ::g::Fuse::Triggers::IPlayback_typeof();
    type->SetFields(9);
}
...
void Pause__Perform_fn(Pause* __this, ::g::Fuse::Node* target)
{
    ...
    uObject* t = (ind1 != NULL) ? ind1 : uAs<uObject*>(target, ::TYPES[10/*Fuse.Triggers.IPlayback*/]);

    if (t != NULL)
        ::g::Fuse::Triggers::IPlayback::Pause(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/]));
}
// }
...
void Play__Perform_fn(Play* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPlayback::Resume(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/]));
}
// }
...
void PlayTo__Perform_fn(PlayTo* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPlayback::PlayTo(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/]), __this->Progress());
}
...
{
    ::TYPES[11] = ::g::Fuse::Triggers::IPulseTrigger_typeof();
    type->SetFields(8,
        ::TYPES[11/*Fuse.Triggers.IPulseTrigger*/], offsetof(::g::Fuse::Triggers::Actions::Pulse, _Target), 0);
}
...
void Pulse__Perform_fn(Pulse* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPulseTrigger::Pulse(uInterface(uPtr(t), ::TYPES[11/*Fuse.Triggers.IPulseTrigger*/]));
}
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.0.5/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof(), NULL);
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetFields(8,
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[2/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[3/*"/Users/kits...*/], 240, ::STRINGS[4/*"Perform"*/], NULL);
    else
...
::g::Uno::Collections::Dictionary* RaiseUserEvent::ConvertArgs()
{
    ...
    if ((_args == NULL) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_args), ::TYPES[12/*Uno.Collections.ICollection<Fuse.Triggers.Actions.UserEventArg>*/])) == 0))
        return NULL;

    ::g::Uno::Collections::Dictionary* d = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<string, object>*/]);

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_args), ::TYPES[14/*Uno.Collections.IEnumerable<Fuse.Triggers.Actions.UserEventArg>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[15/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::Actions::UserEventArg* arg = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[16/*Uno.Collections.IEnumerator<Fuse.Triggers.Actions.UserEventArg>*/]), &ret3), ret3);
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.0.5/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[17] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[18] = ::g::Uno::Action_typeof();
    type->SetFields(8,
        ::TYPES[17/*Fuse.Controls.Navigator*/], offsetof(::g::Fuse::Triggers::Actions::ReleasePage, _pendNavigator), 0,
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    __this->_pendNavigator = ((n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[17/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[17/*Fuse.Controls.Navigator*/]));

    if ((__this->_pendVisual == NULL) || (__this->_pendNavigator == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Requires a ...*/], __this, ::STRINGS[6/*"/Users/kits...*/], 283, ::STRINGS[4/*"Perform"*/], NULL);
        return;
    }

    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)ReleasePage__DeferredRelease_fn, __this), -1, 0);
}
...
{
    ::TYPES[19] = ::g::Fuse::Triggers::Actions::IShow_typeof();
    type->SetFields(8);
}
...
{
    if (uIs(target, ::TYPES[19/*Fuse.Triggers.Actions.IShow*/]))
        ::g::Fuse::Triggers::Actions::IShow::Show(uInterface(uPtr((uObject*)target), ::TYPES[19/*Fuse.Triggers.Actions.IShow*/]));
}
// }
...
void Stop__Perform_fn(Stop* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPlayback::Stop(uInterface(uPtr(t), ::TYPES[10/*Fuse.Triggers.IPlayback*/]));
}
// }
...
{
    ::STRINGS[7] = uString::Const("`TimelineAction` called without a `Timeline` `Target`");
    ::STRINGS[8] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.0.5/actions/$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    type->SetFields(8,
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"`TimelineAc...*/], __this, ::STRINGS[8/*"/Users/kits...*/], 827, ::STRINGS[4/*"Perform"*/], NULL);
        return;
    }
...
{
    ::TYPES[20] = ::g::Fuse::Triggers::Actions::IToggleable_typeof();
    type->SetFields(8,
        ::TYPES[20/*Fuse.Triggers.Actions.IToggleable*/], offsetof(::g::Fuse::Triggers::Actions::Toggle, _Target), 0);
}
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::Actions::IToggleable::Toggle(uInterface(uPtr(t), ::TYPES[20/*Fuse.Triggers.Actions.IToggleable*/]));
}
...
uObject* Toggle::FindTarget(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        uObject* iv = uAs<uObject*>(n, ::TYPES[20/*Fuse.Triggers.Actions.IToggleable*/]);
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/triggers/$.uno
// -------------------------------------------------------------------------------------------------
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)TransitionLayout__Transition_fn, __this), 1, ::g::Fuse::LayoutPriority::Placement());
}
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[21] = ::TYPES[1/*Fuse.Visual*/]->MakeMethod(2/*FindByType<Fuse.Controls.WebView>*/, ::g::Fuse::Controls::WebView_typeof(), NULL);
    type->SetFields(8);
}
...
void WebViewNavAction__Perform_fn(WebViewNavAction* __this, ::g::Fuse::Node* target)
{
    ...
    ::g::Fuse::Controls::WebView* webView = (::g::Fuse::Controls::WebView*)uPtr(v)->FindByType(::TYPES[21/*Fuse.Visual.FindByType<Fuse.Controls.WebView>*/]);
