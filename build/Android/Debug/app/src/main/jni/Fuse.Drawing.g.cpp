...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.5/$.uno
// -----------------------------------------------------------------------------------------------
...
// internal sealed extern class AndroidGraphicsDrawHelper :702
// {
// static AndroidGraphicsDrawHelper() :702
...
// public generated AndroidGraphicsDrawHelper() :702
void AndroidGraphicsDrawHelper__ctor__fn(AndroidGraphicsDrawHelper* __this)
{
    __this->ctor_();
}

// public void DrawImageFill(texture2D texture) :706
...
// private generated void init_DrawCalls() :702
void AndroidGraphicsDrawHelper__init_DrawCalls_fn(AndroidGraphicsDrawHelper* __this)
{
    __this->init_DrawCalls();
}

// public generated AndroidGraphicsDrawHelper New() :702
...
// public generated AndroidGraphicsDrawHelper() [instance] :702
void AndroidGraphicsDrawHelper::ctor_()
{
    init_DrawCalls();
}

// public void DrawImageFill(texture2D texture) [instance] :706
...
// private generated void init_DrawCalls() [instance] :702
...
// public generated AndroidGraphicsDrawHelper New() [static] :702
...
static void AndroidSurface_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.5/$.uno");
    ...
    ::STRINGS[10] = uString::Const("Canvas.Begin was not called");
    ::STRINGS[11] = uString::Const("Object disposed");
    ...
    type->SetFields(6,
        ::g::Uno::Graphics::Framebuffer_typeof(), offsetof(::g::Fuse::Drawing::AndroidSurface, _buffer), 0,
        ::g::Java::Object_typeof(), offsetof(::g::Fuse::Drawing::AndroidSurface, _context), 0,
        ::g::Fuse::DrawContext_typeof(), offsetof(::g::Fuse::Drawing::AndroidSurface, _drawContext), 0,
        ...
        ::g::Uno::Float2_typeof(), offsetof(::g::Fuse::Drawing::AndroidSurface, _size), 0,
...
::g::Fuse::Drawing::Surface_type* AndroidSurface_typeof()
{
    ...
    type = (::g::Fuse::Drawing::Surface_type*)uClassType::New("Fuse.Drawing.AndroidSurface", options);
    type->fp_build_ = AndroidSurface_build;
    type->fp_ctor_ = (void*)AndroidSurface__New1_fn;
    ...
    type->fp_End = (void(*)(::g::Fuse::Drawing::Surface*))AndroidSurface__End_fn;
...
// public AndroidSurface() :58
void AndroidSurface__ctor_1_fn(AndroidSurface* __this)
{
    __this->ctor_1();
}

// private float2 AddSegments(Java.Object path, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments, float2 prevPoint) :507
...
// public override sealed void Begin(Fuse.DrawContext dc, framebuffer fb, float pixelsPerPoint) :400
void AndroidSurface__Begin_fn(AndroidSurface* __this, ::g::Fuse::DrawContext* dc, ::g::Uno::Graphics::Framebuffer* fb, float* pixelsPerPoint)
{
    ...
    ::g::Java::Object* impl = __this->_context;
    ...
    AndroidSurface::LoadBitmap(impl, fb->Size().X, fb->Size().Y);
    AndroidSurface::BeginImpl(impl, fb->Size().X, fb->Size().Y, ::g::OpenGL::GLTextureHandle::op_Explicit1(uPtr(fb->ColorBuffer())->GLTextureHandle()));
}

// private static void BeginImpl(Java.Object _context, int width, int height, int glTextureId) :419
void AndroidSurface__BeginImpl_fn(::g::Java::Object* _context1, int* width, int* height, int* glTextureId)
{
    AndroidSurface::BeginImpl(_context1, *width, *height, *glTextureId);
}

// private static void ConcatTransform(Java.Object cp, Java.Object m) :634
void AndroidSurface__ConcatTransform_fn(::g::Java::Object* cp, ::g::Java::Object* m)
{
    AndroidSurface::ConcatTransform(cp, m);
}

// private static Java.Object CreateFillPaint() :692
void AndroidSurface__CreateFillPaint_fn(::g::Java::Object** __retval)
{
    *__retval = AndroidSurface::CreateFillPaint();
}

// private static Java.Object CreateLinearGradient(int[] colors, float[] stops) :362
...
// public override sealed Fuse.Drawing.SurfacePath CreatePath(Uno.Collections.IList<Fuse.Drawing.LineSegment> segments, [Fuse.Drawing.FillRule fillRule]) :107
...
// private static Java.Object CreateStrokedPaint(float width, int fjoin, int fcap, float miterLimit) :385
...
// public override sealed void Dispose() :77
void AndroidSurface__Dispose_fn(AndroidSurface* __this)
{
    ::g::Uno::Collections::Dictionary__Enumerator<uStrong< ::g::Fuse::Drawing::Brush*>, uStrong< ::g::Java::Object*> > ret5;
    uPtr(__this->_gradientBrushes)->Clear();

    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong< ::g::Fuse::Drawing::Brush*>, uStrong< ::g::Java::Object*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_imageBrushes), &ret5), ret5); enum1.MoveNext(::TYPES[5/*Uno.Collections.Dictionary<Fuse.Drawing.Brush, Java.Object>.Enumerator*/]); )
    {
...
// public override sealed void DisposePath(Fuse.Drawing.SurfacePath path) :579
void AndroidSurface__DisposePath_fn(AndroidSurface* __this, ::g::Fuse::Drawing::SurfacePath* path)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"Duplicate d...*/], path, ::STRINGS[1/*"/Users/kits...*/], 585, ::STRINGS[2/*"DisposePath"*/]);
        return;
    }
...
// private void DrawPath(Java.Object path, Fuse.Drawing.Brush fill, Fuse.Drawing.FillRule fillRule, Java.Object paint) :200
...
// public override sealed void End() :430
void AndroidSurface__End_fn(AndroidSurface* __this)
{
    ...
    AndroidSurface::EndImpl(impl);
}

// private static void EndImpl(Java.Object context) :439
void AndroidSurface__EndImpl_fn(::g::Java::Object* context)
{
    AndroidSurface::EndImpl(context);
}

// public override sealed void FillPath(Fuse.Drawing.SurfacePath path, Fuse.Drawing.Brush fill) :182
...
// private static void FillPathImage(Java.Object cp, Java.Object pathAsObject, Java.Object imageAsObject, float originX, float originY, float tileSizeX, float tileSizeY, float width, float height, bool eoFill, Java.Object paintAsObject) :314
...
// private static void FillPathLinearGradient(Java.Object cp, Java.Object path, Java.Object gradientStore, float startX, float startY, float endX, float endY, bool eoFill, Java.Object pretendPaint) :278
...
// private static void FillPathSolidColor(Java.Object cp, Java.Object pathAsObject, int color, bool eoFill, Java.Object pretendPaint) :260
...
// public static extern void LoadBitmap(Java.Object context, int width, int height) :118
void AndroidSurface__LoadBitmap_fn(::g::Java::Object* context, int* width, int* height)
{
    AndroidSurface::LoadBitmap(context, *width, *height);
}

// private static Java.Object LoadImage(Java.Object cp, int glTextureId, int width, int height) :166
void AndroidSurface__LoadImage_fn(::g::Java::Object* cp, int* glTextureId, int* width, int* height, ::g::Java::Object** __retval)
{
    *__retval = AndroidSurface::LoadImage(cp, *glTextureId, *width, *height);
}

// public AndroidSurface New() :58
void AndroidSurface__New1_fn(AndroidSurface** __retval)
{
    *__retval = AndroidSurface::New1();
}

// private static Java.Object NewContext() :65
void AndroidSurface__NewContext_fn(::g::Java::Object** __retval)
{
    *__retval = AndroidSurface::NewContext();
}

// private static void PathClose(Java.Object pathAsObject) :620
void AndroidSurface__PathClose_fn(::g::Java::Object* pathAsObject)
{
    AndroidSurface::PathClose(pathAsObject);
}

// private static Java.Object PathCreateMutable() :593
void AndroidSurface__PathCreateMutable_fn(::g::Java::Object** __retval)
{
    *__retval = AndroidSurface::PathCreateMutable();
}

// private static void PathCurveTo(Java.Object pathAsObject, float x, float y, float ax, float ay, float bx, float by) :606
...
// public override sealed void PopTransform() :646
void AndroidSurface__PopTransform_fn(AndroidSurface* __this)
{
    __this->VerifyBegun();
    AndroidSurface::RestoreContextState(__this->_context);
}

// public override sealed void Prepare(Fuse.Drawing.Brush brush) :455
void AndroidSurface__Prepare_fn(AndroidSurface* __this, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], brush, ::STRINGS[1/*"/Users/kits...*/], 479, ::STRINGS[7/*"Prepare"*/], NULL);
}

// private void PrepareImageFill(Fuse.Drawing.ImageFill img) :140
void AndroidSurface__PrepareImageFill_fn(AndroidSurface* __this, ::g::Fuse::Drawing::ImageFill* img)
{
    __this->PrepareImageFill(img);
}

// private void PrepareLinearGradient(Fuse.Drawing.LinearGradient lg) :558
...
// public override sealed void PushTransform(float4x4 t) :100
void AndroidSurface__PushTransform_fn(AndroidSurface* __this, ::g::Uno::Float4x4* t)
{
    ::g::Uno::Float4x4 t_ = *t;
    __this->VerifyBegun();
    AndroidSurface::SaveContextState(__this->_context);
    AndroidSurface::ConcatTransform(__this->_context, __this->ToMatrix1(t_, __this->_pixelsPerPoint));
}

// private static void recycleBitmap(Java.Object bit) :660
void AndroidSurface__recycleBitmap_fn(::g::Java::Object* bit)
{
    AndroidSurface::recycleBitmap(bit);
}

// private static void RestoreContextState(Java.Object cp) :653
void AndroidSurface__RestoreContextState_fn(::g::Java::Object* cp)
{
    AndroidSurface::RestoreContextState(cp);
}

// private static void SaveContextState(Java.Object cp) :627
void AndroidSurface__SaveContextState_fn(::g::Java::Object* cp)
{
    AndroidSurface::SaveContextState(cp);
}

// public override sealed void StrokePath(Fuse.Drawing.SurfacePath path, Fuse.Drawing.Stroke stroke) :373
...
// private Java.Object ToMatrix(float[] matrix) :684
...
// private Java.Object ToMatrix(float4x4 transform, float pixelsPerPoint) :672
...
// public override sealed void Unprepare(Fuse.Drawing.Brush brush) :484
void AndroidSurface__Unprepare_fn(AndroidSurface* __this, ::g::Fuse::Drawing::Brush* brush)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(__this->_gradientBrushes), brush, (void**)(&ip), &ret8), ret8))
    {
        __this->VerifyCreated();
        ::g::Uno::Collections::Dictionary__Remove_fn(uPtr(__this->_gradientBrushes), brush, &ret9);
    }

    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(__this->_imageBrushes), brush, (void**)(&ip), &ret10), ret10))
    {
        __this->VerifyCreated();
        AndroidSurface::recycleBitmap(ip);
        ::g::Uno::Collections::Dictionary__Remove_fn(uPtr(__this->_imageBrushes), brush, &ret11);
    }
}

// private void VerifyBegun() :94
void AndroidSurface__VerifyBegun_fn(AndroidSurface* __this)
{
    __this->VerifyBegun();
}

// private void VerifyCreated() :88
void AndroidSurface__VerifyCreated_fn(AndroidSurface* __this)
{
    __this->VerifyCreated();
}

// public AndroidSurface() [instance] :58
void AndroidSurface::ctor_1()
{
    ...
    ctor_();
    _context = AndroidSurface::NewContext();
    ::g::Java::Object* impl = _context;
}

// private float2 AddSegments(Java.Object path, Uno.Collections.IList<Fuse.Drawing.LineSegment> segments, float2 prevPoint) [instance] :507
::g::Uno::Float2 AndroidSurface::AddSegments(::g::Java::Object* path, uObject* segments, ::g::Uno::Float2 prevPoint)
{
    ...
    {
        ::g::Fuse::Drawing::LineSegment seg = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(segments), ::TYPES[4/*Uno.Collections.IList<Fuse.Drawing.LineSegment>*/]), uCRef<int>(i), &ret4), ret4);
...
// private void DrawPath(Java.Object path, Fuse.Drawing.Brush fill, Fuse.Drawing.FillRule fillRule, Java.Object paint) [instance] :200
void AndroidSurface::DrawPath(::g::Java::Object* path, ::g::Fuse::Drawing::Brush* fill, int fillRule, ::g::Java::Object* paint)
{
    ...
    if (solidColor != NULL)
    {
        AndroidSurface::FillPathSolidColor(_context, path, (int)::g::Uno::Color::ToArgb(::g::Fuse::Drawing::ISolidColor::Color(uInterface(uPtr(solidColor), ::TYPES[8/*Fuse.Drawing.ISolidColor*/]))), eoFill, paint);
        return;
    }
    ...
    if (linearGradient != NULL)
    {
        ...
        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_gradientBrushes), fill, (void**)(&gradient), &ret6), ret6))
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"Unprepared ...*/], fill, ::STRINGS[1/*"/Users/kits...*/], 218, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }

        ::g::Uno::Float4 ends = ::g::Uno::Float4__op_Multiply1(uPtr(linearGradient)->GetEffectiveEndPoints(ElementSize()), _pixelsPerPoint);
        AndroidSurface::FillPathLinearGradient(_context, path, gradient, ends.Item(0), ends.Item(1), ends.Item(2), ends.Item(3), eoFill, paint);
        return;
    }
    ...
    if (imageFill != NULL)
    {
        ...
        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_imageBrushes), fill, (void**)(&image), &ret7), ret7))
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Unprepared ...*/], fill, ::STRINGS[1/*"/Users/kits...*/], 234, ::STRINGS[4/*"DrawPath"*/]);
            return;
        }
        ...
        AndroidSurface::FillPathImage(_context, path, image, pixelOrigin.X, pixelOrigin.Y, tileSize.X, tileSize.Y, ElementSize().X * _pixelsPerPoint, ElementSize().Y * _pixelsPerPoint, eoFill, paint);
        return;
    }

    ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"Unsupported...*/], fill, ::STRINGS[1/*"/Users/kits...*/], 255, ::STRINGS[4/*"DrawPath"*/], NULL);
}

// private float2 PixelFromPoint(float2 point) [instance] :501
::g::Uno::Float2 AndroidSurface::PixelFromPoint(::g::Uno::Float2 point)
{
    return ::g::Uno::Float2__op_Multiply1(point, _pixelsPerPoint);
}

// private void PrepareImageFill(Fuse.Drawing.ImageFill img) [instance] :140
void AndroidSurface::PrepareImageFill(::g::Fuse::Drawing::ImageFill* img)
{
    ::g::Fuse::Resources::ImageSource* src = uPtr(img)->Source();

    if ((uPtr(src)->PixelSize().X == 0) || (uPtr(src)->PixelSize().Y == 0))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Recieved an...*/], uBox(::g::Uno::Int2_typeof(), uPtr(src)->PixelSize()), ::STRINGS[1/*"/Users/kits...*/], 146, ::STRINGS[9/*"PrepareImag...*/], NULL);
        return;
    }
    ...
    ::g::Java::Object* imageRef = AndroidSurface::LoadImage(_context, ::g::OpenGL::GLTextureHandle::op_Explicit1(uPtr(tex)->GLTextureHandle()), src->PixelSize().X, src->PixelSize().Y);
    ::g::Fuse::FramebufferPool::Release(fb);
    uPtr(_drawContext)->PopRenderTarget();
    ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(_imageBrushes), img, imageRef);
}

// private void PrepareLinearGradient(Fuse.Drawing.LinearGradient lg) [instance] :558
...
// private Java.Object ToMatrix(float[] matrix) [instance] :684
::g::Java::Object* AndroidSurface::ToMatrix(uArray* matrix)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ToMatrix129", "(Lcom/uno/UnoObject;Lcom/uno/FloatArray;)Ljava/lang/Object;");
        uObject* _uthis=this;
...
// private Java.Object ToMatrix(float4x4 transform, float pixelsPerPoint) [instance] :672
...
// private void VerifyBegun() [instance] :94
void AndroidSurface::VerifyBegun()
{
    if (_buffer == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[10/*"Canvas.Begi...*/]));
}

// private void VerifyCreated() [instance] :88
void AndroidSurface::VerifyCreated()
{
    if (_context == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[11/*"Object disp...*/]));
}

// private static void BeginImpl(Java.Object _context, int width, int height, int glTextureId) [static] :419
void AndroidSurface::BeginImpl(::g::Java::Object* _context1, int width, int height, int glTextureId)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "BeginImpl109", "(Ljava/lang/Object;III)V");
        ::g::Java::Object* __u_context1=_context1;
        jobject ___context1 = (__u_context1==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)__u_context1, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int __uwidth=width;
        ...
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,___context1,__width,__height,__glTextureId);
        
        if (___context1!=NULL) { U_JNIVAR->DeleteLocalRef(___context1); }
...
// private static void ConcatTransform(Java.Object cp, Java.Object m) [static] :634
void AndroidSurface::ConcatTransform(::g::Java::Object* cp, ::g::Java::Object* m)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ConcatTransform110", "(Ljava/lang/Object;Ljava/lang/Object;)V");
...
// private static Java.Object CreateFillPaint() [static] :692
::g::Java::Object* AndroidSurface::CreateFillPaint()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateFillPaint111", "()Ljava/lang/Object;");
...
// private static Java.Object CreateLinearGradient(int[] colors, float[] stops) [static] :362
::g::Java::Object* AndroidSurface::CreateLinearGradient(uArray* colors, uArray* stops)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateLinearGradient112", "(Lcom/uno/IntArray;Lcom/uno/FloatArray;)Ljava/lang/Object;");
...
// private static Java.Object CreateStrokedPaint(float width, int fjoin, int fcap, float miterLimit) [static] :385
::g::Java::Object* AndroidSurface::CreateStrokedPaint(float width, int fjoin, int fcap, float miterLimit)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateStrokedPaint113", "(FIIF)Ljava/lang/Object;");
        float _uwidth=width;
...
// private static void EndImpl(Java.Object context) [static] :439
void AndroidSurface::EndImpl(::g::Java::Object* context)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "EndImpl114", "(Ljava/lang/Object;)V");
...
// private static void FillPathImage(Java.Object cp, Java.Object pathAsObject, Java.Object imageAsObject, float originX, float originY, float tileSizeX, float tileSizeY, float width, float height, bool eoFill, Java.Object paintAsObject) [static] :314
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "FillPathImage115", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;FFFFFFZLjava/lang/Object;)V");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void FillPathLinearGradient(Java.Object cp, Java.Object path, Java.Object gradientStore, float startX, float startY, float endX, float endY, bool eoFill, Java.Object pretendPaint) [static] :278
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "FillPathLinearGradient116", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;FFFFZLjava/lang/Object;)V");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void FillPathSolidColor(Java.Object cp, Java.Object pathAsObject, int color, bool eoFill, Java.Object pretendPaint) [static] :260
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "FillPathSolidColor117", "(Ljava/lang/Object;Ljava/lang/Object;IZLjava/lang/Object;)V");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ::g::Java::Object* _upathAsObject=pathAsObject;
        jobject _pathAsObject = (_upathAsObject==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upathAsObject, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// public static extern void LoadBitmap(Java.Object context, int width, int height) [static] :118
void AndroidSurface::LoadBitmap(::g::Java::Object* context, int width, int height)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadBitmap118", "(Ljava/lang/Object;II)V");
        ::g::Java::Object* _ucontext=context;
        jobject _context = (_ucontext==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucontext, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uwidth=width;
...
// private static Java.Object LoadImage(Java.Object cp, int glTextureId, int width, int height) [static] :166
::g::Java::Object* AndroidSurface::LoadImage(::g::Java::Object* cp, int glTextureId, int width, int height)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadImage119", "(Ljava/lang/Object;III)Ljava/lang/Object;");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        ...
        int _uheight=height;
        jint _height = (jint)_uheight;
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd,_cp,_glTextureId,_width,_height);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        if (_cp!=NULL) { U_JNIVAR->DeleteLocalRef(_cp); }
...
// public AndroidSurface New() [static] :58
AndroidSurface* AndroidSurface::New1()
{
    AndroidSurface* obj3 = (AndroidSurface*)uNew(AndroidSurface_typeof());
    obj3->ctor_1();
    return obj3;
}

// private static Java.Object NewContext() [static] :65
::g::Java::Object* AndroidSurface::NewContext()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "NewContext120", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// private static void PathClose(Java.Object pathAsObject) [static] :620
void AndroidSurface::PathClose(::g::Java::Object* pathAsObject)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PathClose121", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _upathAsObject=pathAsObject;
        jobject _pathAsObject = (_upathAsObject==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upathAsObject, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static Java.Object PathCreateMutable() [static] :593
::g::Java::Object* AndroidSurface::PathCreateMutable()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PathCreateMutable122", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
// private static void PathCurveTo(Java.Object pathAsObject, float x, float y, float ax, float ay, float bx, float by) [static] :606
void AndroidSurface::PathCurveTo(::g::Java::Object* pathAsObject, float x, float y, float ax, float ay, float bx, float by)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PathCurveTo123", "(Ljava/lang/Object;FFFFFF)V");
        ::g::Java::Object* _upathAsObject=pathAsObject;
        jobject _pathAsObject = (_upathAsObject==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upathAsObject, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _ux=x;
...
// private static void PathLineTo(Java.Object pathAsObject, float x, float y) [static] :613
void AndroidSurface::PathLineTo(::g::Java::Object* pathAsObject, float x, float y)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PathLineTo124", "(Ljava/lang/Object;FF)V");
        ::g::Java::Object* _upathAsObject=pathAsObject;
        jobject _pathAsObject = (_upathAsObject==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upathAsObject, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _ux=x;
        jfloat _x = (jfloat)_ux;
...
// private static void PathMoveTo(Java.Object pathAsObject, float x, float y) [static] :599
void AndroidSurface::PathMoveTo(::g::Java::Object* pathAsObject, float x, float y)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "PathMoveTo125", "(Ljava/lang/Object;FF)V");
        ::g::Java::Object* _upathAsObject=pathAsObject;
        jobject _pathAsObject = (_upathAsObject==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upathAsObject, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _ux=x;
        jfloat _x = (jfloat)_ux;
...
// private static void recycleBitmap(Java.Object bit) [static] :660
void AndroidSurface::recycleBitmap(::g::Java::Object* bit)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "recycleBitmap126", "(Ljava/lang/Object;)V");
...
// private static void RestoreContextState(Java.Object cp) [static] :653
void AndroidSurface::RestoreContextState(::g::Java::Object* cp)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "RestoreContextState127", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void SaveContextState(Java.Object cp) [static] :627
void AndroidSurface::SaveContextState(::g::Java::Object* cp)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SaveContextState128", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _ucp=cp;
        jobject _cp = (_ucp==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_ucp, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_cp);
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.5/$.uno
// ---------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("Brush is not pinned, preparation invalid");
    ::STRINGS[13] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.5/$.uno");
    ::STRINGS[7] = uString::Const("Prepare");
    type->SetFields(1,
...
{
    if (!IsPinned())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Brush is no...*/], this, ::STRINGS[13/*"/Users/kits...*/], 71, ::STRINGS[7/*"Prepare"*/]);
...
{
    DrawObjectWatcher::ShadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[14/*"Shading"*/]);
}

static void DrawObjectWatcher_build(uType* type)
{
    ::STRINGS[14] = uString::Const("Shading");
    ::STRINGS[15] = uString::Const("Sync while not rooted");
    ::STRINGS[1] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Surface/1.0.5/$.uno");
...
void DrawObjectWatcher::Sync()
{
    if (!_rooted)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Sync while ...*/], this, ::STRINGS[1/*"/Users/kits...*/], 2856, ::STRINGS[16/*"Sync"*/]);
        return;
    }
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/drawing/$.uno
// ------------------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Drawing/1.0.5/brushes/$.uno
// -----------------------------------------------------------------------------------------------
...
{
    ImageFill::_sourceName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[20/*"Source"*/]);
    ImageFill::_colorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[19/*"Color"*/]);
    ImageFill::_wrapModeName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[21/*"WrapMode"*/]);
    ImageFill::_paramName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[22/*"Param"*/]);
    ImageFill::_sizingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[23/*"Sizing"*/]);
}

static void ImageFill_build(uType* type)
{
    ::STRINGS[20] = uString::Const("Source");
    ::STRINGS[19] = uString::Const("Color");
    ::STRINGS[21] = uString::Const("WrapMode");
    ::STRINGS[22] = uString::Const("Param");
    ::STRINGS[23] = uString::Const("Sizing");
    type->SetInterfaces(
...
static void LinearGradient_build(uType* type)
{
    ...
    ::TYPES[17] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ...
    type->SetFields(3,
        ...
        ::g::Uno::Collections::RootableList_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL), offsetof(::g::Fuse::Drawing::LinearGradient, _stops), 0,
...
{
    ::g::Fuse::Drawing::Brush__OnPinned_fn(__this);
    uPtr(__this->_stops)->RootSubscribe(uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnAdded_fn, __this), uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Drawing.GradientStop>*/], (void*)LinearGradient__OnRemoved_fn, __this));
}
...
{
    uArray* ind4 = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[21/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.GradientStop>*/], (uObject*)_stops);
...
void LinearGradient::ValidateStopsSorted(uObject* stops)
{
    ...
    for (int i = 1; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(stops), ::TYPES[18/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/])); ++i)
        if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[19/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int>(i), &ret7), ret7))->Offset() < uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[19/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int>(i - 1), &ret8), ret8))->Offset())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::Format(::STRINGS[29/*"Gradient st...*/], uArray::Init<uObject*>(::TYPES[20/*object[]*/], 2, uBox(::g::Uno::Float_typeof(), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[19/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int>(i - 1), &ret9), ret9))->Offset()), uBox(::g::Uno::Float_typeof(), uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(stops), ::TYPES[19/*Uno.Collections.IList<Fuse.Drawing.GradientStop>*/]), uCRef<int>(i), &ret10), ret10))->Offset())))));
}
// }
...
{
    ::TYPES[22] = ::g::Uno::Float4_typeof()->Array();
    ::TYPES[12] = ::g::Uno::Float_typeof()->Array();
    ::TYPES[0] = ::g::Uno::Float2_typeof()->Array();
    type->SetFields(0,
...
uArray* LinearGradientDrawable::FillBuffer_Colors_ae3a1d65_1_6_6(int Colors_1_6_4, uArray* Colors_1_6_5)
{
    ...
    uArray* cols = uArray::New(::TYPES[22/*float4[]*/], ::g::Uno::Math::Max8(Colors_1_6_4, 1));
...
{
    Stroke::_shadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[14/*"Shading"*/]);
    ...
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[36/*"LineJoinMit...*/]);
}
...
static void Stroke_build(uType* type)
{
    ...
    ::STRINGS[36] = uString::Const("LineJoinMiterLimit");
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    ::g::Fuse::Drawing::ISurfaceDrawable::Draw(uInterface(uPtr(drawable), ::TYPES[26/*Fuse.Drawing.ISurfaceDrawable*/]), this);
    End();
...
::g::Fuse::Drawing::Surface* SurfaceManager::Create(uObject* owner)
{
    ...
    c = ::g::Fuse::Drawing::AndroidSurface::New1();
    c->Owner = owner;
    return c;
}
