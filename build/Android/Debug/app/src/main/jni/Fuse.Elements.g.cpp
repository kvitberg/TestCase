...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/$.uno
// ----------------------------------------------------------------------------------------
...
// protected generated BoxSizing() :216
void BoxSizing__ctor__fn(BoxSizing* __this)
{
    __this->ctor_();
}

// protected void EffectiveAnchor(Fuse.Elements.Element element, Fuse.Elements.SimpleAlignment halign, Fuse.Elements.SimpleAlignment valign, Uno.UX.Size2& anchor) :303
...
// protected Fuse.Elements.SimpleAlignment EffectiveHorizontalAlignment(Fuse.Elements.Element element) :260
...
// protected Fuse.Elements.SimpleAlignment EffectiveVerticalAlignment(Fuse.Elements.Element element) :277
...
// protected Fuse.LayoutParams GetConstraints(Fuse.Elements.Element element, Fuse.LayoutParams lp, [Fuse.Elements.BoxSizing.ConstraintFlags flags]) :321
...
// public virtual Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :234
...
// public virtual void RequestLayout(Fuse.Elements.Element element) :232
void BoxSizing__RequestLayout_fn(BoxSizing* __this, ::g::Fuse::Elements::Element* element)
{
}

// protected float SimpleToAnchor(Fuse.Elements.SimpleAlignment align) :294
void BoxSizing__SimpleToAnchor_fn(BoxSizing* __this, int* align, float* __retval)
{
    *__retval = __this->SimpleToAnchor(*align);
}

// protected float UnitSize(Fuse.Elements.Element element, Uno.UX.Size value, float relative, bool hasRelative, bool& known) :240
...
// protected generated BoxSizing() [instance] :216
void BoxSizing::ctor_()
{
}

// protected void EffectiveAnchor(Fuse.Elements.Element element, Fuse.Elements.SimpleAlignment halign, Fuse.Elements.SimpleAlignment valign, Uno.UX.Size2& anchor) [instance] :303
...
// protected Fuse.Elements.SimpleAlignment EffectiveHorizontalAlignment(Fuse.Elements.Element element) [instance] :260
...
// protected Fuse.Elements.SimpleAlignment EffectiveVerticalAlignment(Fuse.Elements.Element element) [instance] :277
...
// protected Fuse.LayoutParams GetConstraints(Fuse.Elements.Element element, Fuse.LayoutParams lp, [Fuse.Elements.BoxSizing.ConstraintFlags flags]) [instance] :321
...
// protected float SimpleToAnchor(Fuse.Elements.SimpleAlignment align) [instance] :294
...
// protected float UnitSize(Fuse.Elements.Element element, Uno.UX.Size value, float relative, bool hasRelative, bool& known) [instance] :240
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/caching/$.uno
// ------------------------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/$.uno");
    ...
    ::STRINGS[9] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/$.uno");
    ::STRINGS[10] = uString::Const("Composit");
    ::STRINGS[11] = uString::Const("This element can not be drawn.");
    ::STRINGS[12] = uString::Const("Draw called on a non-rooted node");
    ::STRINGS[13] = uString::Const("Draw");
    ::STRINGS[14] = uString::Const("Invalid values in ArrangeMarginBox");
    ::STRINGS[15] = uString::Const("OnArrangeMarginBox");
    ...
    ::TYPES[8] = ::g::Fuse::Elements::ITreeRenderer_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[10] = ::g::Fuse::Effects::Effect_typeof();
    ::TYPES[11] = ::g::Uno::Action1_typeof()->MakeType(::TYPES[10/*Fuse.Effects.Effect*/], NULL);
    ...
    ::TYPES[23] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[10/*Fuse.Effects.Effect*/], NULL);
    ...
    ::TYPES[29] = ::g::Fuse::Visual_typeof()->MakeMethod(4/*Get<Fuse.Elements.ITransformOrigin>*/, ::TYPES[12/*Fuse.Elements.ITransformOrigin*/], NULL);
    ::TYPES[30] = ::g::Fuse::Visual_typeof()->MakeMethod(10/*Set<Fuse.Elements.ITransformOrigin>*/, ::TYPES[12/*Fuse.Elements.ITransformOrigin*/], NULL);
    ...
    type->SetInterfaces(
        ...
        ::TYPES[15/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(Element_type, interface8),
    ...
    type->SetFields(54,
        ...
        ::g::Uno::Bool_typeof(), (uintptr_t)&::g::Fuse::Elements::Element::_invalidValuesWarn_, uFieldFlagsStatic,
        ...
        ::TYPES[12/*Fuse.Elements.ITransformOrigin*/], (uintptr_t)&::g::Fuse::Elements::Element::DefaultTransformOrigin_, uFieldFlagsStatic,
...
// public Fuse.Elements.CachingMode get_CachingMode() :893
void Element__get_CachingMode_fn(Element* __this, int* __retval)
{
    *__retval = __this->CachingMode();
}

// public void set_CachingMode(Fuse.Elements.CachingMode value) :894
void Element__set_CachingMode_fn(Element* __this, int* value)
{
    __this->CachingMode(*value);
}

// protected virtual Fuse.VisualBounds CalcRenderBounds() :777
...
// protected Fuse.VisualBounds CalcRenderBoundsWithEffects() :725
...
// public framebuffer CaptureRegion(Fuse.DrawContext dc, Uno.Rect region, float2 padding) :904
...
// private void CleanupBatching() :692
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"/Users/kits...*/], 937, ::STRINGS[13/*"Draw"*/]);
...
// protected void DrawNonUnderlayChildren(Fuse.DrawContext dc) :659
...
// protected void DrawUnderlayChildren(Fuse.DrawContext dc) :653
void Element__DrawUnderlayChildren_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    __this->DrawUnderlayChildren(dc);
}

// protected virtual void DrawWithChildren(Fuse.DrawContext dc) :701
...
// private void Fuse.Triggers.Actions.ICollapse.Collapse() :597
void Element__FuseTriggersActionsICollapseCollapse_fn(Element* __this)
{
    __this->Visibility(1);
}

// private void Fuse.Triggers.Actions.IHide.Hide() :598
void Element__FuseTriggersActionsIHideHide_fn(Element* __this)
{
    __this->Visibility(2);
}

// private void Fuse.Triggers.Actions.IShow.Show() :596
...
// internal Uno.Recti GetViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) :795
...
// public Uno.Recti GetVisibleViewportInvertPixelRect(Fuse.DrawContext dc, Fuse.VisualBounds localRegion) :811
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :1454
...
// private bool get_NeedsClipping() :756
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn())
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Invalid val...*/], __this, ::STRINGS[9/*"/Users/kits...*/], 2093, ::STRINGS[15/*"OnArrangeMa...*/]);
...
// protected override void OnChildAdded(Fuse.Node node) :847
void Element__OnChildAdded_fn(Element* __this, ::g::Fuse::Node* node)
{
    ::g::Fuse::Visual__OnChildAdded_fn(__this, node);
    ::g::Fuse::Effects::Effect* e = uAs< ::g::Fuse::Effects::Effect*>(node, ::TYPES[10/*Fuse.Effects.Effect*/]);

    if (e != NULL)
        __this->OnEffectAdded(e);
}

// protected override void OnChildRemoved(Fuse.Node node) :856
...
// protected virtual void OnDraw(Fuse.DrawContext dc) :708
...
void Element__OnIsContextEnabledChanged_fn(Element* __this)
{
    ...
    if (__this->IsRootingCompleted())
    {
        ...
        if (t != NULL)
            ::g::Fuse::Elements::ITreeRenderer::IsEnabledChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), __this, __this->IsEnabled());
    }
}
...
void Element__OnIsVisibleChanged_fn(Element* __this)
{
    ...
    if (__this->IsRootingCompleted())
    {
        ...
        if (t != NULL)
            ::g::Fuse::Elements::ITreeRenderer::IsVisibleChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), __this, __this->IsVisible());
    }
}
...
// protected override sealed void OnZOrderInvalidated() :632
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :2634
...
// private void RemoveChildElementFromBatching(Fuse.Elements.Element elm) :638
void Element__RemoveChildElementFromBatching_fn(Element* __this, Element* elm)
{
    __this->RemoveChildElementFromBatching(elm);
}

// public Fuse.VisualBounds get_RenderBoundsWithEffects() :743
...
// public Fuse.VisualBounds get_RenderBoundsWithoutEffects() :762
...
// public Fuse.Elements.CachingMode get_CachingMode() [instance] :893
...
// public void set_CachingMode(Fuse.Elements.CachingMode value) [instance] :894
...
// protected Fuse.VisualBounds CalcRenderBoundsWithEffects() [instance] :725
...
// public framebuffer CaptureRegion(Fuse.DrawContext dc, Uno.Rect region, float2 padding) [instance] :904
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[7/*"../../../Li...*/], 913);
        return NULL;
    }
...
// private void CleanupBatching() [instance] :692
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"/Users/kits...*/], 1099, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"/Users/kits...*/], 1107, ::STRINGS[10/*"Composit"*/]);
    }
}
...
// protected void DrawNonUnderlayChildren(Fuse.DrawContext dc) [instance] :659
...
// protected void DrawUnderlayChildren(Fuse.DrawContext dc) [instance] :653
...
// internal Uno.Recti GetViewportInvertPixelRect(Fuse.DrawContext dc, Uno.Rect localRegion) [instance] :795
...
// public Uno.Recti GetVisibleViewportInvertPixelRect(Fuse.DrawContext dc, Fuse.VisualBounds localRegion) [instance] :811
...
// private bool get_NeedsClipping() [instance] :756
...
void Element::NotifyTreeRedererOpacityChanged()
{
    if (IsRootingCompleted())
    {
        ...
        if (t != NULL)
            ::g::Fuse::Elements::ITreeRenderer::OpacityChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, Opacity());
    }
}
...
void Element::NotifyTreeRendererHitTestModeChanged()
{
    if (IsRootingCompleted())
    {
        ...
        if (t != NULL)
            ::g::Fuse::Elements::ITreeRenderer::HitTestModeChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, HitTestMode() != 0);
    }
}
...
void Element::NotifyTreeRendererPlaced()
{
    ...
    if (t != NULL)
        ::g::Fuse::Elements::ITreeRenderer::Placed(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this);
}
...
void Element::NotifyTreeRendererRooted()
{
    ...
    if (t != NULL)
    {
        ::g::Fuse::Elements::ITreeRenderer::Rooted(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this);
        ::g::Fuse::Elements::ITreeRenderer::OpacityChanged(uInterface(t, ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, Opacity());
        ::g::Fuse::Elements::ITreeRenderer::IsVisibleChanged(uInterface(t, ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, IsVisible());
        ::g::Fuse::Elements::ITreeRenderer::IsEnabledChanged(uInterface(t, ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, IsEnabled());
        ::g::Fuse::Elements::ITreeRenderer::ClipToBoundsChanged(uInterface(t, ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, ClipToBounds());
        ::g::Fuse::Elements::ITreeRenderer::HitTestModeChanged(uInterface(t, ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, HitTestMode() != 0);

        if (HasChildren())
            ::g::Fuse::Elements::ITreeRenderer::ZOrderChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this, ZOrder());
    }
}
...
void Element::NotifyTreeRendererRootingStarted()
{
    ...
    if (t != NULL)
        ::g::Fuse::Elements::ITreeRenderer::RootingStarted(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this);
}
...
void Element::NotifyTreeRendererTransformChanged()
{
    ...
    {
        ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Element__SetNewTransform_fn, this), 1, ::g::Fuse::LayoutPriority::Post());
...
void Element::NotifyTreeRendererUnrooted()
{
    ...
    if (t != NULL)
        ::g::Fuse::Elements::ITreeRenderer::Unrooted(uInterface(uPtr(TreeRenderer()), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this);
}
...
{
    if (HasChildren())
        ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Element__OnZOrderChanged_fn, this), 1, ::g::Fuse::LayoutPriority::Post());
}
...
void Element::OnEffectAdded(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->add_RenderingChanged(uDelegate::New(::TYPES[11/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
    e->add_RenderBoundsChanged(uDelegate::New(::TYPES[11/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderBoundsChanged_fn, this));
    InvalidateVisual();
}
...
void Element::OnEffectRemoved(::g::Fuse::Effects::Effect* e)
{
    ...
    uPtr(e)->remove_RenderingChanged(uDelegate::New(::TYPES[11/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderingChanged_fn, this));
    e->remove_RenderBoundsChanged(uDelegate::New(::TYPES[11/*Uno.Action<Fuse.Effects.Effect>*/], (void*)Element__OnEffectRenderBoundsChanged_fn, this));
    InvalidateVisual();
}
    ...
    if ((newParent || newPosition) || newSize)
    {
        if (!temp && !_pendingDispatchPlacement)
        {
            ...
            if (TreeRenderer() != NULL)
                ::g::Fuse::UpdateManager::AddDeferredAction1(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Element__NotifyTreeRendererPlaced_fn, this), ::g::Fuse::LayoutPriority::Placement());

            if (::g::Uno::Delegate::op_Inequality(Placed1, NULL))
            {
                ::g::Fuse::UpdateManager::AddDeferredAction1(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)Element__DispatchPlacement_fn, this), ::g::Fuse::LayoutPriority::Placement());
...
// private void RemoveChildElementFromBatching(Fuse.Elements.Element elm) [instance] :638
...
// public Fuse.VisualBounds get_RenderBoundsWithEffects() [instance] :743
...
// public Fuse.VisualBounds get_RenderBoundsWithoutEffects() [instance] :762
...
void Element::SetNewTransform()
{
    if (IsRootingCompleted())
    {
        ...
        if (t != NULL)
            ::g::Fuse::Elements::ITreeRenderer::TransformChanged(uInterface(uPtr(t), ::TYPES[8/*Fuse.Elements.ITreeRenderer*/]), this);
    }
...
// private bool ShouldBatch() [instance] :615
...
{
    ::STRINGS[16] = uString::Const("element not already inserted anywhere!");
    ::STRINGS[17] = uString::Const("wrong atlas again, dummy!");
    ::STRINGS[18] = uString::Const("Removing from wrong atlas");
...
{
    if (uPtr(elm)->ElementBatchEntry() == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[16/*"element not...*/]));
...
void ElementAtlas::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(entry)->_atlas != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[18/*"Removing fr...*/]));
...
{
    ::STRINGS[19] = uString::Const("Cannot Collect while pinned!");
    ::STRINGS[20] = uString::Const("ElementAtlasFramebuffer already pinned");
    ::STRINGS[21] = uString::Const("ElementAtlasFramebuffer not already pinned");
    ::TYPES[34] = ::g::Uno::EventHandler_typeof();
    type->SetFields(0,
...
void ElementAtlasFramebuffer::Collect()
{
    ...
    if (Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[19/*"Cannot Coll...*/]));
...
::g::Uno::Graphics::Framebuffer* ElementAtlasFramebuffer::Pin()
{
    ...
    if (Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[20/*"ElementAtla...*/]));
...
{
    if (!Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[21/*"ElementAtla...*/]));
...
void ElementAtlasFramebufferPool::Initialize()
{
    ...
    ElementAtlasFramebufferPool::UpdateElementAtlasSize();
    ::g::Fuse::Platform::SystemUI::add_FrameChanged(uDelegate::New(::TYPES[34/*Uno.EventHandler*/], (void*)ElementAtlasFramebufferPool__OnResized_fn));
...
// private extern void DiscardPool() :517
...
// private extern void DiscardPool() [instance] :517
...
{
    ::STRINGS[22] = uString::Const("wrong atlas, stupid!");
    ::STRINGS[23] = uString::Const("element has no caching rect");
    ::STRINGS[24] = uString::Const("wrong batch, stupid!");
...
void ElementBatch::AddElement(::g::Fuse::Elements::Element* elm)
{
    if (uPtr(uPtr(elm)->ElementBatchEntry())->_atlas != _elementAtlas)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[22/*"wrong atlas...*/]));
...
void ElementBatch::Dispose()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementBatchEntry*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret9), ret9); enum1.MoveNext(::TYPES[38/*Uno.Collections.List<Fuse.Elements.ElementBatchEntry>.Enumerator*/]); )
    {
...
void ElementBatch::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->ElementBatchEntry())->_batch != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[24/*"wrong batch...*/]));
...
::g::Uno::Recti ElementBatch::GetCachingRect(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(bounds)->IsInfinite() || uPtr(bounds)->IsEmpty())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[23/*"element has...*/]));
...
{
    ::STRINGS[25] = uString::Const("Trying to batch nothing!");
    ::STRINGS[26] = uString::Const("BUG: atlas-insertion failed, but should not!");
    ::STRINGS[27] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/caching/$.uno");
...
void ElementBatcher::Draw(::g::Fuse::DrawContext* dc)
{
    ...
    if (uPtr(_elements)->Count() < 1)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[25/*"Trying to b...*/]));
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret27), ret27); enum4.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            if (atlas == NULL)
            {
                for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret28), ret28); enum5.MoveNext(::TYPES[43/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
                {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[26/*"BUG: atlas-...*/], 1, ::STRINGS[27/*"../../../Li...*/], 1085);
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::ElementAtlas*> > enum6 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_atlasPool), &ret29), ret29); enum6.MoveNext(::TYPES[43/*Uno.Collections.List<Fuse.Elements.ElementAtlas>.Enumerator*/]); )
    {
...
{
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[28/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[29/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[30/*"Translation"*/]);
}

static void InteractiveTransform_build(uType* type)
{
    ::STRINGS[28] = uString::Const("ZoomFactor");
    ::STRINGS[29] = uString::Const("Rotation");
    ::STRINGS[30] = uString::Const("Translation");
    type->SetInterfaces(
...
{
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[9/*Uno.Action*/], (void*)LayoutMasterBoxSizing__LayoutMasterData__CheckLayout_fn, this), -1, 0);
}
...
// public generated StandardBoxSizing() :410
void StandardBoxSizing__ctor_1_fn(StandardBoxSizing* __this)
{
    __this->ctor_1();
}

// public override sealed float2 CalcArrangePaddingSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :514
...
// public override sealed Fuse.Elements.BoxPlacement CalcBoxPlacement(Fuse.Elements.Element element, float2 position, Fuse.LayoutParams lp) :414
...
// public override sealed float2 CalcMarginSize(Fuse.Elements.Element element, Fuse.LayoutParams lp) :496
...
// public override sealed Fuse.LayoutDependent IsContentRelativeSize(Fuse.Elements.Element element) :549
...
// public generated StandardBoxSizing New() :410
void StandardBoxSizing__New1_fn(StandardBoxSizing** __retval)
{
    *__retval = StandardBoxSizing::New1();
}

// private float2 SnapUp(Fuse.Elements.Element element, float2 p) :543
...
// public generated StandardBoxSizing() [instance] :410
...
// private float2 SnapUp(Fuse.Elements.Element element, float2 p) [instance] :543
...
// public generated StandardBoxSizing New() [static] :410
