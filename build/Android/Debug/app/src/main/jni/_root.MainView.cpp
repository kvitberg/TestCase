...
void MainView::InitializeUX()
{
    ...
    ::g::Fuse::Controls::PageControl* temp20 = ::g::Fuse::Controls::PageControl::New4();
    ::g::HomePage* temp21 = ::g::HomePage::New5();
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]), temp21);
