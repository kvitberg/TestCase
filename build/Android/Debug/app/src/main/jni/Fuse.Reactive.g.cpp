...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/$.uno
// ---------------------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Expressions/1.0.5/$.uno
// ----------------------------------------------------------------------------------------------------
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.5/$.uno
// -------------------------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[4/*"JavaScript ...*/], ex, this, ::STRINGS[5/*"/Users/kits...*/], 207, ::STRINGS[6/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/fusejs/$.uno
// ----------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"../../../Li...*/], 135);
    return NULL;
}
...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if (uIs(obj, ::TYPES[25/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[19/*"Array["*/], uBox<int>(::TYPES[19/*int*/], uPtr(a)->Length())), ::STRINGS[20/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[17/*""*/], uBox<int>(::TYPES[19/*int*/], i)), ::STRINGS[18/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[22/*"log"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[23/*"dir"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../../Li...*/], 121);
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[25/*"'"*/], ::g::Uno::Object::ToString(uPtr(__this->Value()))), ::STRINGS[25/*"'"*/]), void();
}
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[26/*"{"*/], __this->Key()), ::STRINGS[27/*"}"*/]), void();
}
...
{
    ::STRINGS[17] = uString::Const("");
    ::STRINGS[28] = uString::Const("Cannot bind '");
    ::STRINGS[29] = uString::Const("' to property '");
    ::STRINGS[30] = uString::Const("'. The observable must contain exactly one ");
    ::STRINGS[31] = uString::Const(".");
    ::STRINGS[32] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.5/$.uno");
    ::STRINGS[33] = uString::Const("InvalidListOperation");
    ::STRINGS[34] = uString::Const("TryPushAsMarshalledValue");
    ::STRINGS[35] = uString::Const("number");
    ::STRINGS[36] = uString::Const("string");
    ::STRINGS[37] = uString::Const("value that can be converted to type ");
...
{
    if (Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(Parent(), &_busyTask, 0, ::STRINGS[17/*""*/]);
}
...
{
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"Cannot bind '"*/], Key()), ::STRINGS[29/*"' to proper...*/]), ::g::Uno::UX::Selector__op_Implicit1(uPtr(Target())->Name())), ::STRINGS[30/*"'. The obse...*/]), DataBinding::TypeToJSName(uPtr(Target())->PropertyType())), ::STRINGS[31/*"."*/]), this, ::STRINGS[32/*"/Users/kits...*/], 200, ::STRINGS[33/*"InvalidList...*/], NULL);
}
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[32/*"/Users/kits...*/], 409, ::STRINGS[34/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
uString* DataBinding::TypeToJSName(uType* t)
{
    if ((::g::Uno::Type::op_Equality(t, ::TYPES[19/*int*/]) || ::g::Uno::Type::op_Equality(t, ::TYPES[20/*float*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[21/*double*/]))
        return ::STRINGS[35/*"number"*/];

    if (::g::Uno::Type::op_Equality(t, ::TYPES[23/*string*/]))
        return ::STRINGS[36/*"string"*/];

    return ::g::Uno::String::op_Addition2(::STRINGS[37/*"value that ...*/], ::g::Uno::Type::FullName(uPtr(t)));
}
// }

// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/1.0.5/subscription/$.uno
// --------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[26] = uString::Const("{");
    ::STRINGS[38] = uString::Const("} not found in data context");
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void DataSubscription::FindData()
{
    ...
    if (!_isResolved)
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[26/*"{"*/], Key()), ::STRINGS[38/*"} not found...*/]), _origin);
}
...
{
    ::STRINGS[39] = uString::Const("debug_log");
    ::STRINGS[13] = uString::Const("null");
    ::STRINGS[12] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/fusejs/$.uno");
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
}
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[39/*"debug_log"*/], uDelegate::New(::TYPES[26/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../../Li...*/], 99);
...
static void JavaScript__DiagnosticSubject_build(uType* type)
{
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    type->SetFields(0,
        ::TYPES[29/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::JavaScript__DiagnosticSubject, _diagnostic), 0);
}
...
void JavaScript__DiagnosticSubject::ClearDiagnostic()
{
    if (_diagnostic != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_diagnostic), ::TYPES[29/*Uno.IDisposable*/]));
        _diagnostic = NULL;
    }
}
...
static void EventRecord_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL), offsetof(::g::Fuse::Reactive::EventRecord, _args), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::EventRecord, _data), 0,
        ::g::Fuse::Node_typeof(), offsetof(::g::Fuse::Reactive::EventRecord, _node), 0,
...
{
    ::STRINGS[40] = uString::Const("The binding type does not support resource subscriptions");
    ::TYPES[37] = ::g::Fuse::Reactive::IExpression_typeof();
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[38] = ::g::Fuse::Reactive::IWriteable_typeof();
    type->SetInterfaces(
...
{
    U_THROW(::g::Uno::Exception::New2(::STRINGS[40/*"The binding...*/]));
}
...
{
    return uIs((uObject*)_expressionSub, ::TYPES[38/*Fuse.Reactive.IWriteable*/]);
}
...
{
    ::g::Fuse::Reactive::IWriteable::SetExclusive(uInterface(uPtr(_expressionSub), ::TYPES[38/*Fuse.Reactive.IWriteable*/]), value);
}
// }
...
{
    uPtr(::g::Fuse::Reactive::JavaScript::Worker())->Invoke(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)FunctionMirror__CallClosure__Call_fn, FunctionMirror__CallClosure::New1(this, e)));
}
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive/1.0.5/$.uno
// ----------------------------------------------------------------------------------------
...
{
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[39] = ::g::Uno::Collections::Dictionary__ValueCollection__Enumerator_typeof()->MakeType(::g::Fuse::Reactive::IExpression_typeof(), InnerListener__ObservableSubscription_typeof(), NULL);
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[40] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Reactive::IExpression_typeof(), InnerListener__ObservableSubscription_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[40/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>*/], offsetof(::g::Fuse::Reactive::InnerListener, _obsSubs), 0);
}
...
void InnerListener__Dispose_fn(InnerListener* __this)
{
    ...
    {
        for (::g::Uno::Collections::Dictionary__ValueCollection__Enumerator<uStrong<InnerListener__ObservableSubscription*> > enum1 = (::g::Uno::Collections::Dictionary__ValueCollection__GetEnumerator_fn(uPtr((::g::Uno::Collections::Dictionary__ValueCollection*)uPtr(__this->_obsSubs)->Values()), &ret2), ret2); enum1.MoveNext(::TYPES[39/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>.ValueCollection.Enumerator*/]); )
        {
            InnerListener__ObservableSubscription* k = enum1.Current(::TYPES[39/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>.ValueCollection.Enumerator*/]);
            uPtr(k)->Dispose();
        }
...
void InnerListener__FuseReactiveIListenerOnNewData_fn(InnerListener* __this, uObject* source, uObject* value)
{
    ...
    {
        if (__this->_obsSubs == NULL)
            __this->_obsSubs = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[40/*Uno.Collections.Dictionary<Fuse.Reactive.IExpression, Fuse.Reactive.InnerListener.ObservableSubscription>*/]));
...
// public sealed class JavaScript :244
// {
...
static void JavaScript_build(uType* type)
{
    ...
    ::STRINGS[47] = uString::Const(" in ");
    ::STRINGS[48] = uString::Const(" line ");
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[41] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[42] = ::g::Uno::UX::Resource_typeof()->MakeMethod(0/*GetGlobalsOfType<Fuse.Scripting.NativeModule>*/, ::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[43] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    type->SetInterfaces(
...
void JavaScript__OnUnrooted_fn(JavaScript* __this)
{
    ...
    if ((--JavaScript::_javaScriptCounter()) <= 0)
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr((uObject*)::g::Uno::UX::Resource::GetGlobalsOfType(::TYPES[42/*Uno.UX.Resource.GetGlobalsOfType<Fuse.Scripting.NativeModule>*/])), ::TYPES[41/*Uno.Collections.IEnumerable<Fuse.Scripting.NativeModule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[8/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Scripting::NativeModule* nm = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[43/*Uno.Collections.IEnumerator<Fuse.Scripting.NativeModule>*/]), &ret3), ret3);
...
// internal static extern void UserScriptError(string msg, Fuse.Scripting.ScriptException ex, object obj, [string filePath], [int lineNumber], [string memberName]) :293
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[42/*"JavaScript ...*/], FileName()), ::STRINGS[43/*" fixed!"*/]), this, ::STRINGS[5/*"/Users/kits...*/], 450, ::STRINGS[44/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[45/*"JavaScript ...*/], se, this, ::STRINGS[5/*"/Users/kits...*/], 466, ::STRINGS[44/*"EvaluateMod...*/]);
...
// internal static extern void UserScriptError(string msg, Fuse.Scripting.ScriptException ex, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :293
void JavaScript::UserScriptError(uString* msg, ::g::Fuse::Scripting::ScriptException* ex, uObject* obj, uString* filePath, int lineNumber, uString* memberName)
{
    ...
    msg = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(msg, ::STRINGS[47/*" in "*/]), uPtr(ex)->FileName()), ::STRINGS[48/*" line "*/]), uBox<int>(::TYPES[19/*int*/], uPtr(ex)->LineNumber()));
...
{
    ::STRINGS[49] = uString::Const(" (ScriptMethod)");
    ::STRINGS[50] = uString::Const("(function (cl, callback) { cl.prototype.");
    ::STRINGS[51] = uString::Const(" = function() { callback(this.external_object, Array.prototype.slice.call(arguments)); }})");
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::Array_typeof();
    type->SetFields(0,
...
void ThreadWorker__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _m = m;
    _worker = worker;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[49/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[50/*"(function (...*/], uPtr(m)->Name), ::STRINGS[51/*" = function...*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
{
    uObject* self = uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[44/*Fuse.Scripting.External*/]))->Object;
...
{
    ::STRINGS[52] = uString::Const("Named object not found: ");
    ::TYPES[27] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
    type->SetFields(0,
...
void Name__GetValue_fn(Name* __this, uObject* context, uObject** __retval)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[52/*"Named objec...*/], __this->Identifier())));
}
...
{
    ::TYPES[45] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[45/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
{
    ::TYPES[46] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[47] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[10] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[48] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::IRaw_typeof(), offsetof(ObjectMirror_type, interface0),
        ::g::Fuse::IObject_typeof(), offsetof(ObjectMirror_type, interface1));
    type->SetFields(1,
        ::TYPES[46/*Uno.Collections.Dictionary<string, object>*/], offsetof(::g::Fuse::Reactive::ObjectMirror, _props), 0);
}
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[47/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[47/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
...
{
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[46/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[48/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_props)->Keys()));
}
...
{
    ::STRINGS[53] = uString::Const("addSubscriber");
    ::STRINGS[54] = uString::Const("set");
    ::STRINGS[55] = uString::Const("clear");
    ::STRINGS[56] = uString::Const("newAt");
    ::STRINGS[57] = uString::Const("newAll");
    ::STRINGS[58] = uString::Const("add");
    ::STRINGS[59] = uString::Const("removeAt");
    ::STRINGS[60] = uString::Const("insertAt");
    ::STRINGS[61] = uString::Const("removeRange");
    ::STRINGS[62] = uString::Const("insertAll");
    ::STRINGS[63] = uString::Const("failed");
    ::STRINGS[64] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[65] = uString::Const("removeSubscriber");
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[50] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof(), NULL);
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[15] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[51] = ::g::Fuse::Reactive::ArrayMirror_typeof();
    ::TYPES[19] = ::g::Uno::Int_typeof();
    ::TYPES[21] = ::g::Uno::Double_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[50/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/], offsetof(::g::Fuse::Reactive::Observable, _observers), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::Observable, _usingObservers), 0,
        ::TYPES[49/*Uno.Collections.List<object>*/], offsetof(::g::Fuse::Reactive::Observable, _values), 0,
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[50/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/]));
    ctor_1(obj);
    _worker = worker;
    _observable = obj;
    ...
    uPtr(obj)->CallMethod(::STRINGS[53/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[22/*bool*/], supressCallback)));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(op, ::STRINGS[54/*"set"*/]))
        ...
        uPtr(_worker)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[51/*Fuse.Reactive.ArrayMirror*/]), origin));
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[59/*"removeAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[61/*"removeRange"*/]))
        uPtr(_worker)->Enqueue(Observable__RemoveRange::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), ToInt(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[62/*"insertAll"*/]))
        uPtr(_worker)->Enqueue(Observable__InsertAll::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(4)), ::TYPES[51/*Fuse.Reactive.ArrayMirror*/])));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[63/*"failed"*/]))
        uPtr(_worker)->Enqueue(Observable__Failed::New1(this, uAs<uString*>(uPtr(args)->Strong<uObject*>(3), ::TYPES[23/*string*/])));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[64/*"Unhandled o...*/], op)));
...
{
    uPtr(_observable)->CallMethod(::STRINGS[65/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}
...
static void ObservableProperty_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[52] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_worker)->Invoke(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[52/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject1())));
}
...
{
    ::TYPES[53] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::Expression_type, interface0));
    type->SetFields(0,
...
{
    ::g::Uno::UX::PropertyObject* obj = uCast< ::g::Uno::UX::PropertyObject*>(uPtr(__this->Object())->GetValue(context), ::TYPES[53/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[66] = uString::Const("this._raw_");
    ::STRINGS[67] = uString::Const("this._");
    ::STRINGS[68] = uString::Const(" (ScriptProperty)");
    ::STRINGS[69] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[70] = uString::Const("', ");
    ::STRINGS[26] = uString::Const("{");
    ::STRINGS[71] = uString::Const("get: function() { ");
    ::STRINGS[72] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[73] = uString::Const("if (");
    ::STRINGS[74] = uString::Const(" != obs) {");
    ::STRINGS[75] = uString::Const(" = obs;");
    ::STRINGS[76] = uString::Const(" = obs");
    ::STRINGS[77] = uString::Const(";");
    ::STRINGS[27] = uString::Const("}");
    ::STRINGS[78] = uString::Const("return ");
...
void ThreadWorker__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Reactive::ThreadWorker* worker)
{
    _worker = worker;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[66/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[67/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(worker)->Context())->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[68/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[69/*"(function(c...*/], p->Name), ::STRINGS[70/*"', "*/]), ::STRINGS[26/*"{"*/]), ::STRINGS[71/*"get: functi...*/]), ::STRINGS[72/*"var obs = g...*/]), ::STRINGS[73/*"if ("*/]), rawField), ::STRINGS[74/*" != obs) {"*/]), rawField), ::STRINGS[75/*" = obs;"*/]), propField), ::STRINGS[76/*" = obs"*/]), p->Modifier), ::STRINGS[77/*";"*/]), ::STRINGS[27/*"}"*/]), ::STRINGS[78/*"return "*/]), propField), ::STRINGS[27/*"}"*/]), ::STRINGS[79/*"})"*/]), ::STRINGS[79/*"})"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
...
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Reactive::ThreadWorker::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[53/*Uno.UX.PropertyObject*/]);
...
{
    ::STRINGS[80] = uString::Const("{Resource ");
    ::STRINGS[38] = uString::Const("} not found in data context");
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[54] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(uPtr(_origin)->Parent())->TryGetResource(_key, uDelegate::New(::TYPES[54/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[5/*Fuse.Reactive.IListener*/]), _source, resource);
    else
        _diag = ::g::Fuse::Diagnostics::ReportTemporalUserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[80/*"{Resource "*/], _key), ::STRINGS[38/*"} not found...*/]), _origin);
}
...
static void RootableScriptModule_build(uType* type)
{
    ...
    ::TYPES[55] = ::g::Uno::Collections::IList_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[81/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(i)));
            ::g::Uno::Collections::List__Add_fn(uPtr(args), uPtr(__this->_worker)->Unwrap((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nt->Objects()), ::TYPES[55/*Uno.Collections.IList<object>*/]), uCRef<int>(i), &ret3), ret3)));
        }
...
{
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[56] = ::g::Fuse::MarshalException_typeof();
    type->SetInterfaces(
...
void UnaryOperator__Subscription::OnNewOperand(uObject* value)
{
    ...
    {
        if (uIs(__t.Exception, ::TYPES[56/*Fuse.MarshalException*/]))
        {
...
{
    ::STRINGS[55] = uString::Const("clear");
    ::STRINGS[82] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[83] = uString::Const("Unexpected null object");
    ::STRINGS[5] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/$.uno");
    ::STRINGS[84] = uString::Const("SetExclusive");
    ::STRINGS[85] = uString::Const("setValueWithOrigin");
    ::STRINGS[86] = uString::Const("Failed to set Observable value");
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[28] = ::g::Fuse::IArray_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::ScriptException_typeof();
...
{
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[55/*"clear"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::ReplaceAllExclusive(uObject* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[82/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, sa, uBox<int>(::TYPES[19/*int*/], _origin)));
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[83/*"Unexpected ...*/], this, ::STRINGS[5/*"/Users/kits...*/], 649, ::STRINGS[84/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[85/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_worker)->Unwrap(newValue), uBox<int>(::TYPES[19/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[86/*"Failed to s...*/], ex, this, ::STRINGS[5/*"/Users/kits...*/], 664, ::STRINGS[84/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
{
    ::STRINGS[87] = uString::Const("Name table missing 'this' pointer");
    ::STRINGS[88] = uString::Const("this");
    ::TYPES[27] = ::g::Fuse::Reactive::IContext_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::ConstantExpression_type, interface0));
}
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(uObject_typeof(), uArray::New(::TYPES[57/*Fuse.Scripting.ScriptMember[]*/], 0));
}

static void ThreadWorker_build(uType* type)
{
    ::STRINGS[89] = uString::Const("Skipped Exception");
    ::STRINGS[5] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/1.0.5/$.uno");
    ::STRINGS[90] = uString::Const("CheckAndThrow");
    ::STRINGS[91] = uString::Const("JavaScript data model contains circular references or is too deep. Some data may not display correctly.");
    ::STRINGS[92] = uString::Const("CreateMirror");
    ::STRINGS[93] = uString::Const("Cannot use object of type '");
    ::STRINGS[94] = uString::Const("' as 'this' in JavaScript module; must be 'IProperties' or 'App'");
    ::STRINGS[95] = uString::Const("external_object");
    ::STRINGS[96] = uString::Const(" (ScriptClass)");
    ::STRINGS[97] = uString::Const("(function(external_object) { this.external_object = external_object; })");
    ::STRINGS[98] = uString::Const("(set-superclass)");
    ::STRINGS[99] = uString::Const("(function(cl, superclass) { cl.prototype = new superclass(); cl.prototype.constructor = cl; })");
    ::STRINGS[31] = uString::Const(".");
    ::STRINGS[49] = uString::Const(" (ScriptMethod)");
    ::STRINGS[100] = uString::Const("(function(cl, Observable) { cl.prototype.");
    ::STRINGS[101] = uString::Const(" = ");
    ::STRINGS[102] = uString::Const("; })");
    ::STRINGS[103] = uString::Const("ThreadWorked failed");
    ::STRINGS[104] = uString::Const("Run");
    ::STRINGS[105] = uString::Const("Could not create script context");
    ::TYPES[30] = ::g::Uno::Type_typeof();
    ::TYPES[57] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[58] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Reactive::Observable__Operation_typeof(), NULL);
    ::TYPES[59] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Scripting::ScriptClass_typeof(), ::g::Fuse::Scripting::Function_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[62] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[15] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[63] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[64] = ::g::Fuse::IProperties_typeof();
    ::TYPES[65] = ::g::Fuse::Reactive::ClassInstance_typeof();
    ::TYPES[44] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[66] = ::g::Fuse::Scripting::ScriptMethodInline_typeof();
    ::TYPES[67] = ::g::Fuse::Scripting::ScriptMethod_typeof();
    ::TYPES[68] = ::g::Fuse::Scripting::ScriptProperty_typeof();
    ::TYPES[33] = ::g::Uno::Exception_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[69] = ::g::Fuse::IRaw_typeof();
    ::TYPES[70] = ::g::Uno::Float2_typeof();
    ::TYPES[71] = ::g::Uno::Float3_typeof();
    ::TYPES[72] = ::g::Uno::Float4_typeof();
    ::TYPES[73] = ::g::Uno::Int2_typeof();
    ::TYPES[74] = ::g::Uno::Int3_typeof();
    ::TYPES[75] = ::g::Uno::Int4_typeof();
    ::TYPES[20] = ::g::Uno::Float_typeof();
    ::TYPES[19] = ::g::Uno::Int_typeof();
    ::TYPES[76] = ::g::Uno::UInt_typeof();
    ::TYPES[77] = ::g::Fuse::Scripting::IScriptObject_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[61/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _exceptionQueue), 0,
        ::g::Uno::Threading::ManualResetEvent_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _idle), 0,
        ::TYPES[58/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _messages), 0,
        uObject_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _messagesMutex), 0,
        ::TYPES[60/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _queue), 0,
        ...
        ::TYPES[59/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _registeredClasses), 0,
...
{
    _messages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[58/*Uno.Collections.List<Fuse.Reactive.Observable.Operation>*/]));
    _messagesMutex = ::g::Uno::Object::New();
    _registeredClasses = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[59/*Uno.Collections.Dictionary<Fuse.Scripting.ScriptClass, Fuse.Scripting.Function>*/]));
    ...
    _queue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[60/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    _exceptionQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[61/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
    _thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[62/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
    uPtr(_ready)->Dispose();
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[89/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"/Users/kits...*/], 1864, ::STRINGS[90/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[91/*"JavaScript ...*/], this, ::STRINGS[5/*"/Users/kits...*/], 1434, ::STRINGS[92/*"CreateMirror"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[63/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
    uPtr(_terminate)->Set();
    uPtr(_thread)->Join();
...
{
    uObject* n = uAs<uObject*>(obj, ::TYPES[64/*Fuse.IProperties*/]);

    if (n != NULL)
    {
        ::g::Fuse::Reactive::ClassInstance* ni = uAs< ::g::Fuse::Reactive::ClassInstance*>(uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[64/*Fuse.IProperties*/])))->Get(_classInstanceProperty), ::TYPES[65/*Fuse.Reactive.ClassInstance*/]);

        if (ni == NULL)
        {
            ni = ::g::Fuse::Reactive::ClassInstance::New1(this, obj, rootTable);
            uPtr(::g::Fuse::IProperties::Properties(uInterface(uPtr(n), ::TYPES[64/*Fuse.IProperties*/])))->Set(_classInstanceProperty, ni);
        }

        return ni;
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[93/*"Cannot use ...*/], ::g::Uno::Type::FullName(uPtr(::g::Uno::Object::GetType(uPtr(uPtr(rootTable)->This()))))), ::STRINGS[94/*"' as 'this'...*/])));
}
...
{
    ::g::Fuse::Scripting::External* e = uAs< ::g::Fuse::Scripting::External*>(obj, ::TYPES[44/*Fuse.Scripting.External*/]);
    ...
    if (sobj != NULL)
    {
        if (uPtr(sobj)->ContainsKey(::STRINGS[95/*"external_ob...*/]))
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[95/*"external_ob...*/]), ::TYPES[44/*Fuse.Scripting.External*/]);
...
{
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[96/*" (ScriptCla...*/]), ::STRINGS[97/*"(function(e...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::STRINGS[98/*"(set-superc...*/], ::STRINGS[99/*"(function(c...*/]), ::TYPES[24/*Fuse.Scripting.Function*/]);
    ...
    {
        ::g::Fuse::Scripting::ScriptMethodInline* inlineMethod = uAs< ::g::Fuse::Scripting::ScriptMethodInline*>(uPtr(uPtr(sc)->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[66/*Fuse.Scripting.ScriptMethodInline*/]);

        if (inlineMethod != NULL)
        {
            ::g::Fuse::Scripting::Function* m = uCast< ::g::Fuse::Scripting::Function*>(uPtr(Context())->Evaluate(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[31/*"."*/]), uPtr(inlineMethod)->Name), ::STRINGS[49/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[100/*"(function(c...*/], uPtr(inlineMethod)->Name), ::STRINGS[101/*" = "*/]), uPtr(inlineMethod)->Code), ::STRINGS[102/*"; })"*/])), ::TYPES[24/*Fuse.Scripting.Function*/]);
            uPtr(m)->Call(uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, cl, (::g::Fuse::Scripting::Function*)uPtr(Context())->Observable()));
            continue;
        }

        ::g::Fuse::Scripting::ScriptMethod* method = uAs< ::g::Fuse::Scripting::ScriptMethod*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[67/*Fuse.Scripting.ScriptMethod*/]);
        ...
        ::g::Fuse::Scripting::ScriptProperty* property = uAs< ::g::Fuse::Scripting::ScriptProperty*>(uPtr(sc->Members())->Strong< ::g::Fuse::Scripting::ScriptMember*>(i), ::TYPES[68/*Fuse.Scripting.ScriptProperty*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[103/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"/Users/kits...*/], 1760, ::STRINGS[104/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context() == NULL)
        {
            ...
            if (ThreadWorker::_context() == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[105/*"Could not c...*/]));
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[63/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
uObject* ThreadWorker::Unwrap(uObject* dc)
{
    if (dc == NULL)
        ...
        return dc;
    else if (uIs(dc, ::TYPES[69/*Fuse.IRaw*/]))
        return ::g::Fuse::IRaw::Raw(uInterface(uPtr((uObject*)dc), ::TYPES[69/*Fuse.IRaw*/]));
    else if (uIs(dc, ::TYPES[24/*Fuse.Scripting.Function*/]))
        return dc;
    else if (uIs(dc, ::TYPES[70/*float2*/]))
        return ToArray(uUnbox< ::g::Uno::Float2>(::TYPES[70/*float2*/], dc));
    else if (uIs(dc, ::TYPES[71/*float3*/]))
        return ToArray1(uUnbox< ::g::Uno::Float3>(::TYPES[71/*float3*/], dc));
    else if (uIs(dc, ::TYPES[72/*float4*/]))
        return ToArray2(uUnbox< ::g::Uno::Float4>(::TYPES[72/*float4*/], dc));
    else if (uIs(dc, ::TYPES[73/*int2*/]))
        return ToArray3(uUnbox< ::g::Uno::Int2>(::TYPES[73/*int2*/], dc));
    else if (uIs(dc, ::TYPES[74/*int3*/]))
        return ToArray4(uUnbox< ::g::Uno::Int3>(::TYPES[74/*int3*/], dc));
    else if (uIs(dc, ::TYPES[75/*int4*/]))
        return ToArray5(uUnbox< ::g::Uno::Int4>(::TYPES[75/*int4*/], dc));
...
{
    uObject* so = uAs<uObject*>(obj, ::TYPES[77/*Fuse.Scripting.IScriptObject*/]);

    if ((so != NULL) && (::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[77/*Fuse.Scripting.IScriptObject*/])) != NULL))
        return ::g::Fuse::Scripting::IScriptObject::ScriptObject(uInterface(uPtr(so), ::TYPES[77/*Fuse.Scripting.IScriptObject*/]));
    ...
    if (so != NULL)
        ::g::Fuse::Scripting::IScriptObject::SetScriptObject(uInterface(uPtr(so), ::TYPES[77/*Fuse.Scripting.IScriptObject*/]), res, Context());
...
uObject* ThreadWorker::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[44/*Fuse.Scripting.External*/]))
        return uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[44/*Fuse.Scripting.External*/]))->Object;
    ...
    if (uIs(obj, ::TYPES[76/*uint*/]))
        return uBox(::TYPES[21/*double*/], (double)uUnbox<uint32_t>(::TYPES[76/*uint*/], obj));
...
{
    ::TYPES[78] = ValueForwarder__IValueListener_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface0),
        ::g::Fuse::Reactive::IObserver_typeof(), offsetof(::g::Fuse::Reactive::ValueObserver_type, interface1));
    type->SetFields(2,
        ::TYPES[78/*Fuse.Reactive.ValueForwarder.IValueListener*/], offsetof(::g::Fuse::Reactive::ValueForwarder, _listener), 0);
}
...
{
    ValueForwarder__IValueListener::NewValue(uInterface(uPtr(__this->_listener), ::TYPES[78/*Fuse.Reactive.ValueForwarder.IValueListener*/]), newValue);
}
...
{
    return *__retval = uBox(::TYPES[71/*float3*/], ::g::Uno::Float3__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third))), void();
}

// public override sealed string ToString() :1300
void Vector3__ToString_fn(Vector3* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"("*/], __this->First()), ::STRINGS[81/*", "*/]), __this->Second()), ::STRINGS[81/*", "*/]), __this->Third()), ::STRINGS[11/*")"*/]), void();
}
// }
...
{
    return *__retval = uBox(::TYPES[72/*float4*/], ::g::Uno::Float4__New2(::g::Fuse::Marshal::ToFloat(first), ::g::Fuse::Marshal::ToFloat(second), ::g::Fuse::Marshal::ToFloat(third), ::g::Fuse::Marshal::ToFloat(fourth))), void();
}

// public override sealed string ToString() :1316
void Vector4__ToString_fn(Vector4* __this, uString** __retval)
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[8/*"("*/], __this->First()), ::STRINGS[81/*", "*/]), __this->Second()), ::STRINGS[81/*", "*/]), __this->Third()), ::STRINGS[81/*", "*/]), __this->Fourth()), ::STRINGS[11/*")"*/]), void();
}
// }
