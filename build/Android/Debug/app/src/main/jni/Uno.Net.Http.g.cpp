...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.13/$.uno
// ----------------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Uno.Net.Http/1.0.13/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"../../../Li...*/], 17);
    else
...
static void HttpMessageHandlerRequest_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("GET");
    ::STRINGS[9] = uString::Const("HEAD");
    ::STRINGS[10] = uString::Const("Not allowed to set header \"");
    ::STRINGS[11] = uString::Const("\" on this target.");
...
void HttpMessageHandlerRequest::SendAsync1(uArray* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[8/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[9/*"HEAD"*/])) || (data == NULL)) || (uPtr(data)->Length() == 0))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[3/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
    {
...
void HttpMessageHandlerRequest::SendAsync2(uString* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[8/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[9/*"HEAD"*/])) || ::g::Uno::String::op_Equality(data, NULL)) || ::g::Uno::String::op_Equality(data, ::STRINGS[7/*""*/]))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[3/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
...
void HttpMessageHandlerRequest::SetHeader(uString* name, uString* value)
{
    ...
    if (!HttpMessageHandlerRequest::IsHeaderValid(name, value))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"Not allowed...*/], name), ::STRINGS[11/*"\" on this ...*/])));
...
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Informational_ = (uObject*)(collection5 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(100), ::STRINGS[12/*"Continue"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(101), ::STRINGS[13/*"Switching P...*/]), collection5);
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(200), ::STRINGS[14/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(201), ::STRINGS[15/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(202), ::STRINGS[16/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(203), ::STRINGS[17/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(204), ::STRINGS[18/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(205), ::STRINGS[19/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(206), ::STRINGS[20/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(300), ::STRINGS[21/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(301), ::STRINGS[22/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(302), ::STRINGS[23/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(303), ::STRINGS[24/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(304), ::STRINGS[25/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(305), ::STRINGS[26/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(307), ::STRINGS[27/*"Temporary R...*/]), collection3);
    HttpStatusReasonPhrase::ClientErrors_ = (uObject*)(collection2 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(400), ::STRINGS[28/*"Bad Request"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(401), ::STRINGS[29/*"Unauthorized"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(402), ::STRINGS[30/*"Payment Req...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(403), ::STRINGS[31/*"Forbidden"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(404), ::STRINGS[32/*"Not Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(405), ::STRINGS[33/*"Method Not ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(406), ::STRINGS[34/*"Not Accepta...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(407), ::STRINGS[35/*"Proxy Authe...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(408), ::STRINGS[36/*"Request Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(409), ::STRINGS[37/*"Conflict"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(410), ::STRINGS[38/*"Gone"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(411), ::STRINGS[39/*"Length Requ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(412), ::STRINGS[40/*"Preconditio...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(413), ::STRINGS[41/*"Request Ent...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(414), ::STRINGS[42/*"Request-URI...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(415), ::STRINGS[43/*"Unsupported...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(416), ::STRINGS[44/*"Requested r...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(417), ::STRINGS[45/*"Expectation...*/]), collection2);
    HttpStatusReasonPhrase::ServerErrors_ = (uObject*)(collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[13/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(500), ::STRINGS[46/*"Internal Se...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(501), ::STRINGS[47/*"Not Impleme...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(502), ::STRINGS[48/*"Bad Gateway"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(503), ::STRINGS[49/*"Service Una...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(504), ::STRINGS[50/*"Gateway Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(505), ::STRINGS[51/*"HTTP Versio...*/]), collection1);
}

static void HttpStatusReasonPhrase_build(uType* type)
{
    ::STRINGS[12] = uString::Const("Continue");
    ::STRINGS[13] = uString::Const("Switching Protocols");
    ::STRINGS[14] = uString::Const("OK");
    ::STRINGS[15] = uString::Const("Created");
    ::STRINGS[16] = uString::Const("Accepted");
    ::STRINGS[17] = uString::Const("Non-Authoritative Information");
    ::STRINGS[18] = uString::Const("No Content");
    ::STRINGS[19] = uString::Const("Reset Content");
    ::STRINGS[20] = uString::Const("Partial Content");
    ::STRINGS[21] = uString::Const("Multiple Choices");
    ::STRINGS[22] = uString::Const("Moved Permanently");
    ::STRINGS[23] = uString::Const("Found");
    ::STRINGS[24] = uString::Const("See Other");
    ::STRINGS[25] = uString::Const("Not Modified");
    ::STRINGS[26] = uString::Const("Use Proxy");
    ::STRINGS[27] = uString::Const("Temporary Redirect");
    ::STRINGS[28] = uString::Const("Bad Request");
    ::STRINGS[29] = uString::Const("Unauthorized");
    ::STRINGS[30] = uString::Const("Payment Required");
    ::STRINGS[31] = uString::Const("Forbidden");
    ::STRINGS[32] = uString::Const("Not Found");
    ::STRINGS[33] = uString::Const("Method Not Allowed");
    ::STRINGS[34] = uString::Const("Not Acceptable");
    ::STRINGS[35] = uString::Const("Proxy Authentication Required");
    ::STRINGS[36] = uString::Const("Request Time-out");
    ::STRINGS[37] = uString::Const("Conflict");
    ::STRINGS[38] = uString::Const("Gone");
    ::STRINGS[39] = uString::Const("Length Required");
    ::STRINGS[40] = uString::Const("Precondition Failed");
    ::STRINGS[41] = uString::Const("Request Entity Too Large");
    ::STRINGS[42] = uString::Const("Request-URI Too Large");
    ::STRINGS[43] = uString::Const("Unsupported Media Type");
    ::STRINGS[44] = uString::Const("Requested range not satisfiable");
    ::STRINGS[45] = uString::Const("Expectation Failed");
    ::STRINGS[46] = uString::Const("Internal Server Error");
    ::STRINGS[47] = uString::Const("Not Implemented");
    ::STRINGS[48] = uString::Const("Bad Gateway");
    ::STRINGS[49] = uString::Const("Service Unavailable");
    ::STRINGS[50] = uString::Const("Gateway Time-out");
    ::STRINGS[51] = uString::Const("HTTP Version not supported");
...
{
    ::STRINGS[52] = uString::Const("Response type is invalid.");
    type->SetFields(3);
}
...
{
    ::STRINGS[53] = uString::Const("The object is in an invalid state.");
    type->SetFields(3);
}
