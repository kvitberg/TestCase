...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/resources/$.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[2] = uString::Const("HttpImageSource-failed-request");
    ::STRINGS[3] = uString::Const("HttpImageSource-failed-converson");
    ...
    ::STRINGS[8] = uString::Const("HttpImageSource-protocol-failure for url '");
    ::STRINGS[9] = uString::Const("' : ");
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[13] = ::g::Uno::Action2_typeof()->MakeType(::g::Experimental::Http::HttpResponseHeader_typeof(), ::g::Uno::Buffer_typeof(), NULL);
...
void HttpImageSourceImpl__AttemptLoad_fn(HttpImageSourceImpl* __this)
{
    try
    {
        ::g::Experimental::Http::HttpLoader::LoadBinary(__this->Url(), uDelegate::New(::TYPES[13/*Uno.Action<Experimental.Http.HttpResponseHeader, Uno.Buffer>*/], (void*)HttpImageSourceImpl__HttpCallback_fn, __this), uDelegate::New(::TYPES[14/*Uno.Action<string>*/], (void*)HttpImageSourceImpl__LoadFailed_fn, __this));
        __this->_loading = true;
        __this->OnChanged();
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
        __this->Fail(::STRINGS[2/*"HttpImageSo...*/], e);
    }
}
...
void HttpImageSourceImpl::HttpCallback(::g::Experimental::Http::HttpResponseHeader* response, ::g::Uno::Buffer* data)
{
    ...
    {
        Fail(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[4/*"HttpImageSo...*/], uBox<int>(::TYPES[22/*int*/], uPtr(response)->StatusCode())), ::STRINGS[5/*" "*/]), uPtr(response)->ReasonPhrase()), NULL);
        return;
    }
...
{
    Fail(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[8/*"HttpImageSo...*/], Url()), ::STRINGS[9/*"' : "*/]), reason), NULL);
}
...
static void ImageSource_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.0.5/resources/$.uno");
    ::STRINGS[13] = uString::Const("OnError");
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[15/*Uno.EventHandler*/], offsetof(::g::Fuse::Resources::ImageSource, Changed1), 0,
        ::TYPES[16/*Fuse.Resources.ImageSourceErrorHandler*/], offsetof(::g::Fuse::Resources::ImageSource, Error1), 0);
}
...
{
    ::g::Fuse::Diagnostics::UnknownException(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"ImageSource...*/], msg), ::STRINGS[11/*"'"*/]), e, this, ::STRINGS[12/*"/Users/kits...*/], 616, ::STRINGS[13/*"OnError"*/]);
...
static void MultiDensityImageSource_build(uType* type)
{
    ...
    type->SetFields(4,
        ...
        ::TYPES[17/*Uno.Collections.ObservableList<Fuse.Resources.ImageSource>*/], offsetof(::g::Fuse::Resources::MultiDensityImageSource, _sources), 0);
}
...
void MultiDensityImageSource::SelectActive()
{
    ...
    for (uObject* enum1 = (uObject*)uPtr(_sources)->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[19/*Uno.Collections.IEnumerator*/])); )
    {
...
{
    bool q = (uIs(o, ::TYPES[21/*float*/]) || uIs(o, ::TYPES[22/*int*/])) || uIs(o, ::TYPES[23/*double*/]);
    return q;
}
...
double NumericResourceConverter::InternConvert(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[23/*double*/]))
        return uUnbox<double>(::TYPES[23/*double*/], o);

    if (uIs(o, ::TYPES[22/*int*/]))
...
static void ProxyImageSource_build(uType* type)
{
    ::TYPES[15] = ::g::Uno::EventHandler_typeof();
    ::TYPES[16] = ::g::Fuse::Resources::ImageSourceErrorHandler_typeof();
    ::TYPES[24] = ::g::Fuse::Resources::LoadingImageSource_typeof();
...
void ProxyImageSource::Attach(::g::Fuse::Resources::ImageSource* impl)
{
    ...
    ::g::Fuse::Resources::LoadingImageSource* loading = uAs< ::g::Fuse::Resources::LoadingImageSource*>(impl, ::TYPES[24/*Fuse.Resources.LoadingImageSource*/]);
...
{
    return (_impl == NULL) ? uCast< ::g::Uno::Graphics::Texture2D*>(NULL, ::TYPES[25/*texture2D*/]) : (::g::Uno::Graphics::Texture2D*)uPtr(_impl)->GetTexture();
}
...
{
    ::g::Fuse::Resources::LoadingImageSource* loading = uAs< ::g::Fuse::Resources::LoadingImageSource*>(_impl, ::TYPES[24/*Fuse.Resources.LoadingImageSource*/]);
...
{
    ::TYPES[26] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[27] = ::g::Fuse::Resources::IResourceConverter_typeof();
    ::TYPES[28] = ::g::Fuse::Resources::ResourceConverters_typeof();
    ::TYPES[0] = ::g::Uno::Action_typeof();
    type->SetPrecalc(
        type->T(0),
    ...
    type->SetFields(1,
        ::TYPES[27/*Fuse.Resources.IResourceConverter`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Resources::ResourceBinding, _converter), 0,
...
void ResourceBinding::OnChanged()
{
    ...
    if (uPtr(Parent())->TryGetResource(Key(), uDelegate::New(::TYPES[26/*Uno.Predicate<object>*/], uInterface(uPtr(_converter), __types[1]), offsetof(::g::Fuse::Resources::IResourceConverter, fp_Accept)), &resource))
...
{
    ResourceConverters::_converters_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[29/*Uno.Collections.Dictionary<Uno.Type, object>*/]));
}

static void ResourceConverters_build(uType* type)
{
    ::TYPES[29] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), uObject_typeof(), NULL);
    ::TYPES[30] = ::g::Uno::Type_typeof();
    ::TYPES[31] = ::g::Fuse::Resources::GenericResourceConverter_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[31/*Fuse.Resources.GenericResourceConverter`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->SetFields(0,
        ::TYPES[29/*Uno.Collections.Dictionary<Uno.Type, object>*/], (uintptr_t)&::g::Fuse::Resources::ResourceConverters::_converters_, uFieldFlagsStatic);
}
...
uObject* ResourceConverters::Get(uType* __type)
{
    ...
    {
        if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[21/*float*/]))
            converter = ::g::Fuse::Resources::FloatResourceConverter::New1();
        else if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[23/*double*/]))
            converter = ::g::Fuse::Resources::DoubleResourceConverter::New1();
        else if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[22/*int*/]))
...
{
    ResourceRegistry::_handlers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[32/*Uno.Collections.Dictionary<string, Uno.Collections.List<Uno.Action>>*/]));
}

static void ResourceRegistry_build(uType* type)
{
    ::TYPES[32] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL), NULL);
    ::TYPES[33] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[32/*Uno.Collections.Dictionary<string, Uno.Collections.List<Uno.Action>>*/], (uintptr_t)&::g::Fuse::Resources::ResourceRegistry::_handlers_, uFieldFlagsStatic);
}
...
void ResourceRegistry::AddResourceChangedHandler(uString* key, uDelegate* handler)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(ResourceRegistry::_handlers()), key, &ret2), ret2))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(ResourceRegistry::_handlers()), key, (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[33/*Uno.Collections.List<Uno.Action>*/]));
...
void ResourceRegistry::NotifyResourceChanged(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(ResourceRegistry::_handlers()), key, (void**)(&list), &ret4), ret4))
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong<uDelegate*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(list), &ret5), ret5); enum1.MoveNext(::TYPES[34/*Uno.Collections.List<Uno.Action>.Enumerator*/]); )
        {
            uDelegate* h = enum1.Current(::TYPES[34/*Uno.Collections.List<Uno.Action>.Enumerator*/]);
            uPtr(h)->InvokeVoid();
        }
}
