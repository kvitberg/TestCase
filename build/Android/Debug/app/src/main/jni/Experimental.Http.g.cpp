...
#include <Experimental.Cache.IC-2fb0e23a.h>
#include <Experimental.Cache.IC-9cfb21d2.h>
...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Experimental.Http/1.0.5/$.uno
// --------------------------------------------------------------------------------------------
...
static void Loader_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Experimental.Http/1.0.5/$.uno");
...
bool Loader::LoadCache(uObject* record)
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log2(e, 1, ::STRINGS[9/*"../../../Li...*/], 853);
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[10/*"Failed load...*/], Uri), 1, ::STRINGS[9/*"../../../Li...*/], 854);
