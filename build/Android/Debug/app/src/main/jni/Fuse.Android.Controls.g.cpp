...
{
    __this->ctor_8(host, handle, schemes);
}
...
{
    *__retval = WebView::New4(host, handle, schemes);
}
...
void WebView::ctor_8(::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes)
{
    ctor_6(handle);
    _webViewHost = host;
...
WebView* WebView::Create(::g::Fuse::Controls::WebView* webViewHost, uArray* schemes)
{
    ...
    return WebView::New4(webViewHost, handle, schemes);
}

// private WebView New(Fuse.Controls.WebView host, Java.Object handle, string[] schemes) [static] :116
WebView* WebView::New4(::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes)
{
    WebView* obj2 = (WebView*)uNew(WebView_typeof());
    obj2->ctor_8(host, handle, schemes);
    return obj2;
}
// }
