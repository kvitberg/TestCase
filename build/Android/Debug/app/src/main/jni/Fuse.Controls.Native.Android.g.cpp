...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/1.0.5/android/$.uno
// -------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[1] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Java::Object_typeof(), ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Int_typeof(), NULL);
    ::TYPES[3] = ::g::Fuse::Visual_typeof();
    ::TYPES[4] = ::g::Fuse::Controls::Native::NativeRootViewport_typeof();
    ::TYPES[5] = ::g::Fuse::ICommonViewport_typeof();
    ::TYPES[6] = ::g::Uno::Exception_typeof();
    type->SetFields(0,
        ::TYPES[2/*Uno.Collections.HashSet<int>*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::InputDispatch::_activePointers_, uFieldFlagsStatic,
        ::TYPES[1/*Uno.Collections.Dictionary<Java.Object, Fuse.Visual>*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::InputDispatch::_listeners_, uFieldFlagsStatic,
...
void InputDispatch::RaiseEvent(::g::Fuse::Visual* visual, ::g::Java::Object* viewHandle, ::g::Fuse::Controls::Native::Android::MotionEvent* motionEvent)
{
    ...
    ::g::Fuse::Controls::Native::NativeRootViewport* rootViewport = uAs< ::g::Fuse::Controls::Native::NativeRootViewport*>(rootVisual, ::TYPES[4/*Fuse.Controls.Native.NativeRootViewport*/]);

    if (rootViewport != NULL)
        rootView = uPtr(uPtr(rootViewport)->RootView())->NativeHandle;

    int action = uPtr(motionEvent)->ActionMasked();
    uArray* data = motionEvent->PointerEventDataForView(rootView, viewHandle, ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(visual)->Viewport()), ::TYPES[5/*Fuse.ICommonViewport*/])));
...
{
    MotionEvent::_locationOnScreen_ = uArray::New(::TYPES[7/*int[]*/], 2);
}

static void MotionEvent_build(uType* type)
{
    ::TYPES[7] = ::g::Uno::Int_typeof()->Array();
    ::TYPES[8] = ::g::Fuse::Input::PointerEventData_typeof()->Array();
    type->SetFields(0,
        ::g::Java::Object_typeof(), offsetof(::g::Fuse::Controls::Native::Android::MotionEvent, _handle), 0,
        ::TYPES[7/*int[]*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::MotionEvent::_locationOnScreen_, uFieldFlagsStatic);
}
...
uArray* MotionEvent::PointerEventDataForView(::g::Java::Object* rootView, ::g::Java::Object* view, float pointDensity)
{
    ...
    uArray* pointerEventData = uArray::New(::TYPES[8/*Fuse.Input.PointerEventData[]*/], PointerCount());
...
{
    ::TYPES[9] = ::g::Fuse::Controls::Native::IScrollViewHost_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(5,
        ...
        ::TYPES[9/*Fuse.Controls.Native.IScrollViewHost*/], offsetof(::g::Fuse::Controls::Native::Android::ScrollView, _host), 0);
}
...
{
    float p = ::g::Fuse::Controls::Native::IScrollViewHost::PixelsPerPoint(uInterface(uPtr(_host), ::TYPES[9/*Fuse.Controls.Native.IScrollViewHost*/]));
    ::g::Fuse::Controls::Native::IScrollViewHost::OnScrollPositionChanged(uInterface(uPtr(_host), ::TYPES[9/*Fuse.Controls.Native.IScrollViewHost*/]), ::g::Uno::Float2__New2((float)x / p, (float)y / p));
}

// public void set_ScrollPosition(float2 value) [instance] :1250
void ScrollView::ScrollPosition(::g::Uno::Float2 value)
{
    ::g::Uno::Int2 x = ::g::Uno::Int2__op_Explicit(::g::Uno::Float2__op_Multiply1(value, ::g::Fuse::Controls::Native::IScrollViewHost::PixelsPerPoint(uInterface(uPtr(_host), ::TYPES[9/*Fuse.Controls.Native.IScrollViewHost*/]))));
...
static void Shape_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/1.0.5/android/$.uno");
    ::STRINGS[2] = uString::Const("SetBrush");
    ::TYPES[10] = ::g::Fuse::Drawing::LinearGradient_typeof();
    ::TYPES[11] = ::g::Fuse::Drawing::SolidColor_typeof();
    ::TYPES[12] = ::g::Fuse::Drawing::StaticSolidColor_typeof();
    ::TYPES[13] = ::g::Fuse::Drawing::DynamicBrush_typeof();
    ::TYPES[14] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(3/*OrderBy<Fuse.Drawing.GradientStop>*/, ::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[16] = ::g::Uno::Func2_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), ::g::Fuse::Drawing::GradientStop_typeof(), ::g::Uno::Int_typeof(), NULL);
    ::TYPES[7] = ::g::Uno::Int_typeof()->Array();
...
{
    if (uIs(brush, ::TYPES[10/*Fuse.Drawing.LinearGradient*/]))
        SetLinearGradient(shapeDrawable, uCast< ::g::Fuse::Drawing::LinearGradient*>(brush, ::TYPES[10/*Fuse.Drawing.LinearGradient*/]));
    else
    {
        ::g::Uno::Float4 c = ::g::Uno::Float4__New1(0.0f);
        ::g::Fuse::Drawing::SolidColor* sc = uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[11/*Fuse.Drawing.SolidColor*/]);

        if (sc != NULL)
            c = uPtr(sc)->Color();

        ::g::Fuse::Drawing::StaticSolidColor* ssc = uAs< ::g::Fuse::Drawing::StaticSolidColor*>(brush, ::TYPES[12/*Fuse.Drawing.StaticSolidColor*/]);

        if (ssc != NULL)
            c = uPtr(ssc)->Color();

        if ((sc == NULL) && (ssc == NULL))
            ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*""*/], brush, ::STRINGS[1/*"/Users/kits...*/], 1368, ::STRINGS[2/*"SetBrush"*/]);
...
{
    uArray* stops = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[14/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Drawing.GradientStop>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::OrderBy1(::TYPES[15/*Uno.Collections.EnumerableExtensions.OrderBy<Fuse.Drawing.GradientStop>*/], uPtr(linearGradient)->Stops(), uDelegate::New(::TYPES[16/*Uno.Func<Fuse.Drawing.GradientStop, Fuse.Drawing.GradientStop, int>*/], (void*)Shape__SelectOffset_fn)));
...
static void Slider_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Controls::Native::IView_typeof(), offsetof(::g::Fuse::Controls::Native::Android::View_type, interface1));
    type->SetFields(5,
        ::TYPES[18/*Fuse.Controls.Native.IRangeViewHost*/], offsetof(::g::Fuse::Controls::Native::Android::Slider, _host), 0);
}
...
static void Switch_build(uType* type)
{
    ...
    type->SetFields(5,
        ::TYPES[19/*Fuse.Controls.Native.IToggleViewHost*/], offsetof(::g::Fuse::Controls::Native::Android::Switch, _host), 0);
}
...
// public sealed extern class TextInput :1741
// {
static void TextInput_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::TYPES[20/*Uno.IDisposable*/], offsetof(::g::Fuse::Controls::Native::Android::TextView_type, interface0),
    ...
    type->SetFields(5,
        ::TYPES[20/*Uno.IDisposable*/], offsetof(::g::Fuse::Controls::Native::Android::TextInput, _focusEvent), 0,
        ::TYPES[21/*Fuse.Controls.Native.ITextEditHost*/], offsetof(::g::Fuse::Controls::Native::Android::TextInput, _host), 0,
...
void TextInput__Measure_fn(TextInput* __this, ::g::Fuse::LayoutParams* lp, float* density, ::g::Uno::Float2* __retval)
{
    ...
    if (__this->_isMultiline)
    {
        ...
        uArray* measuredSize = uArray::New(::TYPES[7/*int[]*/], 2);
...
static void Typeface_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[22/*Java.Object*/], offsetof(::g::Fuse::Controls::Native::Android::Typeface, _handle), 0);
}
...
static void TypefaceCache_build(uType* type)
{
    ...
    ::TYPES[23] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Fuse::Controls::Native::Android::Typeface_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::UX::BundleFileSource_typeof();
    ::TYPES[25] = ::g::Fuse::Resources::SystemFileSource_typeof();
    type->SetFields(0,
        ::TYPES[23/*Uno.Collections.Dictionary<string, Fuse.Controls.Native.Android.Typeface>*/], (uintptr_t)&::g::Fuse::Controls::Native::Android::TypefaceCache::_typefaces_, uFieldFlagsStatic);
}
