...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Motion/1.0.5/$.uno
// --------------------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/kitsco12/Library/Application Support/Fusetools/Packages/Fuse.Motion/1.0.5/$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"/Users/kits...*/], 401, ::STRINGS[2/*"Create"*/], NULL);
...
static void SpringFunction__Subscription_build(uType* type)
{
    ...
    type->SetInterfaces(
        ::TYPES[8/*Uno.IDisposable*/], offsetof(SpringFunction__Subscription_type, interface0),
    ...
    type->SetFields(0,
        ...
        ::TYPES[7/*Fuse.Motion.Simulation.ElasticForce<float4>*/], offsetof(::g::Fuse::Motion::SpringFunction__Subscription, _sim), 0,
        ::TYPES[8/*Uno.IDisposable*/], offsetof(::g::Fuse::Motion::SpringFunction__Subscription, _valueSub), 0);
}
...
{
    if (_valueSub != NULL)
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(_valueSub), ::TYPES[8/*Uno.IDisposable*/]));
...
void SpringFunction__Subscription::StartSimulation()
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[10/*Uno.Action*/], (void*)SpringFunction__Subscription__Simulate_fn, this), 0);
    _isSimulating = true;
}
...
void SpringFunction__Subscription::StopSimulation()
{
    ...
    ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[10/*Uno.Action*/], (void*)SpringFunction__Subscription__Simulate_fn, this), 0);
    _isSimulating = false;
}
