...
// /Users/kitsco12/Library/Application Support/Fusetools/Packages/UnoCore/1.0.13/targets/android/uno/base/$.uno
// ------------------------------------------------------------------------------------------------------------
...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../../Library/Application Support/Fusetools/Packages/UnoCore/1.0.13/targets/android/uno/base/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../../Li...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
{
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"../../../Li...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;
