...
struct FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text : ::g::Uno::UX::PropertyAccessor
{
    ...
    static ::g::Uno::UX::Selector& _name() { return FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text_typeof()->Init(), Singleton_; }
