    ...
    public static void AddEditorActionListener207(final UnoObject _this, final Object handle)
    {
        ((android.widget.TextView)handle).setOnEditorActionListener(new android.widget.TextView.OnEditorActionListener() {
        	public boolean onEditorAction(android.widget.TextView v, int actionId, android.view.KeyEvent ke) {
        		return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction208((UnoObject)_this,(int)actionId);
        	}
        });
    }
    ...
    public static void AddTextChangedListener209(final UnoObject _this, final Object handle)
    {
        ((android.widget.TextView)handle).addTextChangedListener(new android.text.TextWatcher() {
        	...
        	public void onTextChanged(java.lang.CharSequence cs, int start, int before, int count) {
        		...
        		ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged210((UnoObject)_this,(String)str);
        	}
        });
    }
