...
public class TestCase extends android.support.v7.app.AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback
{
//#if !#(LIBRARY:Defined)

    // state
    private static App fuseApp;  // lasts through all resurrections
